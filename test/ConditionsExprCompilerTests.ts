...
describe("ConditionsExprCompiler", function () {
  before(function () {
    ...
    return (this.checkCondition = function (questionType: any, questionOptions: any, op: any, rhs: any, expected: any) {
      ...
      const conditions = [{ lhs: { question: "q1" }, op, rhs: { literal: rhs } }]
      ...
      return this.checkCondition("TextQuestion", {}, "present", null, {
        ...
        exprs: [
          { table: this.tableId, type: "op", op: "is not null", exprs: [this.valueField] },
          {
            ...
            type: "op",
            op: "<>",
            exprs: [this.valueField, { type: "literal", valueType: "text", value: "" }]
          }
        ]
      })
    })
        ...
        exprs: [
          {
            ...
            type: "op",
            op: "is not null",
            exprs: [{ type: "field", table: this.tableId, column: "data:q1:value:cbt:mpn" }]
          },
          {
            table: this.tableId,
            type: "op",
            op: "is not null",
            exprs: [{ type: "field", table: this.tableId, column: "data:q1:value:image" }]
          }
        ]
      })
    })
  ...
  describe("contains", () =>
    it("text", function () {
      return this.checkCondition("TextQuestion", {}, "contains", "a.b", {
        ...
        type: "op",
        op: "~*",
        exprs: [this.valueField, { type: "literal", valueType: "text", value: "\\x61\\.b" }]
      })
    }))
  ...
  describe("=", () =>
    it("number", function () {
      return this.checkCondition("NumberQuestion", {}, "=", 3, {
        ...
        type: "op",
        op: "=",
        exprs: [this.valueField, { type: "literal", valueType: "number", value: 3 }]
      })
    }))
  ...
  describe("is", function () {
    it("choice", function () {
      return this.checkCondition("RadioQuestion", { choices: [{ id: "abc" }] }, "is", "abc", {
        ...
        type: "op",
        op: "=",
        exprs: [this.valueField, { type: "literal", valueType: "enum", value: "abc" }]
      })
    })
    ...
    return it("alternate", function () {
      this.checkCondition(
        "RadioQuestion",
        { choices: [{ id: "abc" }], alternates: { na: true, dontknow: true } },
        "is",
        "dontknow",
        {
          type: "op",
          table: this.tableId,
          op: "is not null",
          exprs: [{ type: "field", table: this.tableId, column: "data:q1:dontknow" }]
        }
      )
      ...
      return this.checkCondition(
        ...
        "na",
        {
          ...
          table: this.tableId,
          op: "is not null",
          exprs: [{ type: "field", table: this.tableId, column: "data:q1:na" }]
        }
      )
    })
  })
  ...
  describe("includes", function () {
    it("choices", function () {
      return this.checkCondition("MulticheckQuestion", { choices: [{ id: "abc" }] }, "includes", "abc", {
        ...
        type: "op",
        op: "contains",
        exprs: [this.valueField, { type: "literal", valueType: "enumset", value: ["abc"] }]
      })
    })
  ...
  describe("before", function () {
    it("date", function () {
      return this.checkCondition("DateQuestion", { format: "MM/DD/YYYY" }, "before", "2014-12-31", {
        ...
        type: "op",
        op: "<",
        exprs: [this.valueField, { type: "literal", valueType: "date", value: "2014-12-31" }]
      })
    })
    ...
    return it("datetime", function () {
      return this.checkCondition("DateQuestion", { format: "MM/DD/YYYY HH:mm" }, "before", "2014-12-31", {
        ...
        type: "op",
        op: "<",
        exprs: [this.valueField, { type: "literal", valueType: "datetime", value: "2014-12-31" }]
      })
    })
  })
  ...
  describe("true", () =>
    it("boolean", function () {
      return this.checkCondition("CheckQuestion", {}, "true", null, this.valueField)
    }))
  ...
  describe("isoneof", function () {
    it("choice", function () {
      return this.checkCondition(
        "RadioQuestion",
        { choices: [{ id: "abc" }, { id: "def" }], alternates: { na: true, dontknow: true } },
        "isoneof",
        ["abc", "def"],
        {
          table: this.tableId,
          type: "op",
          op: "= any",
          exprs: [this.valueField, { type: "literal", valueType: "enumset", value: ["abc", "def"] }]
        }
      )
    })
        ...
        ["abc", "def"],
        {
          ...
          exprs: [
            ...
            },
            {
              ...
              type: "op",
              op: "contains",
              exprs: [this.valueField, { type: "literal", valueType: "enumset", value: ["def"] }]
            }
          ]
        }
      )
