...
describe("ResponseRow", function() {
  before(function() {
    ...
    return this.testField = (data, column, expected, done) => {
  ...
  describe("values", function() {
    ...
    it("gets location", function(done) {
      return this.testField({ qlocation: { value: { latitude: 3, longitude: 4 }}}, "data:qlocation:value", { type: "Point", coordinates: [4, 3] }, done);
    });
    ...
    it("gets units", function(done) {
      return this.testField({ qunits: { value: { quantity: 4, units: "abc" } }}, "data:qunits:value:units", "abc", done);
    });
  ...
  it("gets specify", function(done) {
    return this.testField({ qchoice: { value: "abc", specify: { abc: "sometext" } }}, "data:qchoice:specify:abc", "sometext", done);
  });
  ...
  it("gets comments", function(done) {
    return this.testField({ qchoice: { value: "abc", comments: "sometext" }}, "data:qchoice:comments", "sometext", done);
  });
  ...
  it("gets location", function(done) {
    return this.testField({ qtext: { location: { latitude: 3, longitude: 4 }}}, "data:qtext:location", { type: "Point", coordinates: [4, 3] }, done);
  });
