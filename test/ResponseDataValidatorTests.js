...
describe("ResponseDataValidator", function() {
  before(function() {
    ...
    return this.responseRow = {
      getField(columnId) { return Promise.resolve([null, null, null, null, null]); },
      followJoin(columnId) { return Promise.resolve([null, null, null, null, null]); }
    };});
  ...
  describe("without sections", function() {
    ...
    it("ok", function(done) {
      ...
      return visibilityCalculator.createVisibilityStructure(data, this.responseRow, async (error, visibilityStructure) => {
