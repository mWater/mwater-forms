    ...
    const entityTypes = [
      {
        code: "water_point",
        name: { en: "Water point" },
        properties: [{ id: "name", type: "text", name: { en: "Name" }, roles: [{ id: "all", role: "admin" }] }]
      }
    ]
    ...
    const entityTypes = [
      {
        code: "water_point",
        name: { en: "Water point" },
        properties: [{ id: "date", type: "date", name: { en: "Date" }, roles: [{ id: "all", role: "admin" }] }]
      }
    ]
    const schema = new EntitySchemaBuilder().addEntities(new Schema(), entityTypes)
            ...
            exprs: [
              {
                ...
                exprs: [
                  ...
                  { type: "literal", value: "water_point" }
                ]
              },
              {
                type: "op",
