...
export default () => describe("Common question tests", function() {
  beforeEach(function() {
  ...
  it("records timestamp", function() {
    ...
    assert(this.model.get("q1234").timestamp.substr(0,10) >= before.substr(0,10), this.model.get("q1234").timestamp + " < " + before);
    return assert(this.model.get("q1234").timestamp.substr(0,10) <= after.substr(0,10), this.model.get("q1234").timestamp + " > " + after);
  });
