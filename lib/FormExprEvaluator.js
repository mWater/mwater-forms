...
module.exports = FormExprEvaluator = (function() {
  ...
  FormExprEvaluator.prototype.renderString = function(localizedStr, exprs, data, locale) {
    var str;
    if (locale == null) {
      locale = "en";
    }
    ...
    str = str.replace(/\{(\d+)\}/g, (function(_this) {
      return function(match, index) {
        ...
        if (exprs != null ? exprs[index] : void 0) {
          return _this.evaluateExpr(exprs[index], data) || "";
        }
        return "";
      };
    })(this));
  ...
  FormExprEvaluator.prototype.evaluateExpr = function(expr, data) {
    var row;
    row = {
