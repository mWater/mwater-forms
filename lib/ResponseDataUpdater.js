var ResponseDataUpdater, formUtils;

formUtils = require('./formUtils');

module.exports = ResponseDataUpdater = (function() {
  function ResponseDataUpdater(formDesign, schema, dataSource) {
    var i, item, len, ref;
  ...
  ResponseDataUpdater.prototype.canUpdate = function(expr) {
    if (expr.type === "field") {
  ...
  ResponseDataUpdater.prototype.updateData = function(data, expr, value, callback, suppressCleaning) {
  ...
  ResponseDataUpdater.prototype.updateValue = function(data, expr, value, callback) {
  ...
  ResponseDataUpdater.prototype.updateQuantity = function(data, expr, value, callback) {
  ...
  ResponseDataUpdater.prototype.updateUnits = function(data, expr, value, callback) {
    var answer, change, question;
