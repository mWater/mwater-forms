...
module.exports = ResponseViewEditComponent = function () {
  var ResponseViewEditComponent = function (_React$Component) {
    _inherits(ResponseViewEditComponent, _React$Component);

    function ResponseViewEditComponent(props) {
      _classCallCheck(this, ResponseViewEditComponent);

      var ref;

      var _this = _possibleConstructorReturn(this, (ResponseViewEditComponent.__proto__ || Object.getPrototypeOf(ResponseViewEditComponent)).call(this, props));
    ...
    _createClass(ResponseViewEditComponent, [{
