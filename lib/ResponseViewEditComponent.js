...
class ResponseViewEditComponent extends react_1.default.Component {
    constructor(props) {
        ...
        this.state.locale = props.locale || ((_a = props.form.design.locales[0]) === null || _a === void 0 ? void 0 : _a.code) || "en";
    }
    // Create a response model
    createResponseModel(response) {
        var _a, _b, _c;
        let responseModel;
        return (responseModel = new ResponseModel_1.default({
            response,
    ...
    render() {
        ...
        if (this.state.editMode) {
            ...
            const actions = R("div", { style: { width: "auto", float: "right", margin: 5 } }, this.renderOperations(), responseModel.canRedraft() || responseModel.canEdit()
                ...
                }, R("span", { className: "glyphicon glyphicon-edit" }), "Edit Response")
                : undefined);
        ...
        return R("div", null, printUrl !== null
            ? R("div", { style: { textAlign: "right" } }, R("a", { className: "btn btn-xs btn-link", target: "_blank", href: printUrl }, R(bootstrap_1.default.Icon, { id: "fa-external-link" }), " Export as PDF"))
            : undefined, this.renderLocales(), elem);
    }
}
