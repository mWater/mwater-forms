...
exports.SurveyView = SurveyView = (function(superClass) {
  extend(SurveyView, superClass);
...
exports.WaterTestEditView = WaterTestEditView = (function(superClass) {
  extend(WaterTestEditView, superClass);
