...
*/
var createdModifiedSchema, deployments, rolesSchema; // A deployment is a grouping of people who can answer a form and an optional approval chain and viewers.
    ...
    properties: {
      ...
      entityCreationSettings: {
        ...
        items: {
          ...
          properties: {
            questionId: {
              type: "string" // _id of EntityQuestion that creates the entity

            },
            conditions: {
              type: "array" // Optional conditions that determine if these settings will be applied. See design schema for forms for definition

            },
            enumeratorRole: {
              "enum": ["limited", "view", "edit", "admin" // Role, if any, that enumerator gets
              ]
            },
            createdFor: {
              type: "string" // Group that entity is created for
...
rolesSchema = {
  type: "array",
  minItems: 0,
  // Can be zero in the case of deleted responses
  items: {
    type: "object",
    properties: {
      id: {
  ...
  properties: {
    ...
    indicatorCalculations: {
      ...
      items: {
        ...
        properties: {
          _id: {
            type: "string" // Unique id of calculation

          },
          indicator: {
            type: "string" // Id of indicator

          },
          roster: {
            type: "string" // Id of roster if from a roster

          },
          expressions: {
            type: "object" // Map of indicator property id to mwater-expression expression to create value

          },
          condition: {
            type: ["object", "null" // Optional mwater-expression expression to restrict when to create indicator value
            ]
          },
          datetimeExpr: {
            type: ["object", "null" // Optional mwater-expression expression to select datetime of indicator value. Defaults to submittedOn
            ]
          },
