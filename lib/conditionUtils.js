...
exports.rhsChoices = function (lhsQuestion, op) {
  var choices, ref; // Doesn't apply to LikertQuestions/MatrixQuestions since simple conditions don't apply to them

  if ((ref = lhsQuestion._type) !== "LikertQuestion" && ref !== "MatrixQuestion") {
