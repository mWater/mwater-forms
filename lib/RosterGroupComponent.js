  ...
  var RosterGroupComponent = function (_React$Component) {
    ...
    (0, _createClass3.default)(RosterGroupComponent, [{
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                ...
                case 3:
                  ...
                  entry = ref[index];
                  _context.next = 7;
                  return this['itemlist_' + index].validate(scrollToFirstInvalid && !foundInvalid);
      ...
      value: function renderEntry(entry, index) {
        ...
        return R('div', {
        ...
        }, index + 1 + '. ', this.renderEntryTitle(entry, index)), R('div', {
          key: "body",
          ...
          ref: function ref(c) {
            return _this2['itemlist_' + index] = c;
          },
      ...
      value: function render() {
        ...
        return R('div', {
          ...
          return _this3.renderEntry(entry, index);
