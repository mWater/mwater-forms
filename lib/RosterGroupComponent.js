var FormExprEvaluator, H, R, React, RosterGroupComponent, _, formUtils,
...
module.exports = RosterGroupComponent = (function(superClass) {
  ...
  RosterGroupComponent.prototype.renderEntryTitle = function(entry, index) {
    return this.props.formExprEvaluator.renderString(this.props.rosterGroup.entryTitle, this.props.rosterGroup.entryTitleExprs, this.getAnswer()[index].data, this.context.locale);
  };
