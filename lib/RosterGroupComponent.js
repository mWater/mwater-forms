...
class RosterGroupComponent extends react_1.default.Component {
    ...
    render() {
        return R("div", { style: { padding: 5, marginBottom: 20, overflowX: 'auto' } }, this.renderName(), lodash_1.default.map(this.getAnswer(), (entry, index) => this.renderEntry(entry, index)), 
