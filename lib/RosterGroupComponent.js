...
class RosterGroupComponent extends react_1.default.Component {
    ...
    renderEntry(entry, index) {
        ...
        return R("div", { key: index, className: "card" }, R("div", { key: "header", className: "card-header", style: { fontWeight: "bold", position: "relative" } }, `${index + 1}. `, this.renderEntryTitle(entry, index), R("button", {
            className: "btn btn-link",
            style: { position: "absolute", right: 0, top: 5 },
            onClick: this.handleToggle.bind(null, index)
        }, R("span", {
            className: classnames_1.default("fas", { "fa-chevron-up": !isCollapsed, "fa-chevron-down": isCollapsed })
