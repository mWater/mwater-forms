var H, PropTypes, R, React, RosterGroupComponent, TextExprsComponent, _, formUtils,
...
module.exports = RosterGroupComponent = (function(superClass) {
  ...
  RosterGroupComponent.prototype.renderEmptyPrompt = function() {
    return H.div({
      style: {
        fontStyle: "italic"
      }
  ...
  RosterGroupComponent.prototype.render = function() {
    ...
    })(this)), this.getAnswer().length === 0 && this.props.rosterGroup.allowAdd ? this.renderEmptyPrompt() : void 0, this.renderAdd());
  };
