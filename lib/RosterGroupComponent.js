...
class RosterGroupComponent extends react_1.default.Component {
    ...
    renderEntry(entry, index) {
        return R("div", { key: index, className: "panel panel-default" }, R("div", { key: "header", className: "panel-heading", style: { fontWeight: "bold" } }, `${index + 1}. `, this.renderEntryTitle(entry, index)), R("div", { key: "body", className: "panel-body" }, this.props.rosterGroup.allowRemove
            ? R("button", {
                type: "button",
                style: { float: "right" },
