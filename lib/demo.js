var AdminRegionSelectComponent, CleaningEntity, DemoComponent, FormComponent, H, ItemListComponent, R, React, ReactDOM, StickyEntity, VisibilityEntity, canada, formCtx, manitoba, ontario, rosterFormDesign, sampleForm2, sampleFormDesign, testStickyStorage,
...
DemoComponent = (function(superClass) {
  ...
  function DemoComponent() {
    ...
    var data, visibilityStructure;
    DemoComponent.__super__.constructor.apply(this, arguments);
    data = {};
    visibilityStructure = this.computeVisibility(data);
    this.state = {
      data: data,
  ...
  DemoComponent.prototype.getChildContext = function() {
    formCtx['isVisible'] = this.isVisible;
    return formCtx;
  };

  DemoComponent.prototype.isVisible = function(itemId) {
  ...
  DemoComponent.prototype.handleDataChange = function(data) {
    ...
    newData = this.stickyData(data, formCtx.stickyStorage, oldVisibilityStructure, newVisibilityStructure);
  ...
  DemoComponent.prototype.computeVisibility = function(data) {
  ...
  DemoComponent.prototype.cleanData = function(data, visibilityStructure) {
    var cleaningEntity;
    cleaningEntity = new CleaningEntity();
    return cleaningEntity.cleanData(sampleForm2, data, visibilityStructure);
  };

  DemoComponent.prototype.stickyData = function(data, visibilityStructure) {
    var stickyEntity;
