var DemoComponent, FormComponent, FormSchemaBuilder, H, ImageUploaderModalComponent, ItemListComponent, R, React, ReactDOM, ResponseDisplayComponent, Schema, canada, formCtx, manitoba, matrixFormDesign, ontario, rosterFormDesign, sampleForm2, sampleFormDesign, testStickyStorage,
...
$(function() {
  ...
  return ImageUploaderModalComponent.show("http://localhost:1234/v3/", null, window.T, function(id) {
    return alert(id);
  });
});
