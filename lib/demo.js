...
DragDropContext = require("react-dnd").DragDropContext; // Setup mock localizer
...
function (_React$Component) {
  ...
  function DemoComponent(props) {
    ...
    _this.handleDataChange = _this.handleDataChange.bind((0, _assertThisInitialized2["default"])(_this)); // data = { site01: { value: { code: "10007"}, confidential: true}}
  ...
  (0, _createClass2["default"])(DemoComponent, [{
    ...
    value: function render() {
      ...
      design = sampleForm2.design; // design = sampleFormAdvancedValidations.design
