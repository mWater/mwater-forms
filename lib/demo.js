...
formCtx = {
    ...
    if (tableId === "custom.ts.cities") {
      return new Promise(function (resolve, reject) {
        return setTimeout(function () {
          return resolve(cascadingRefRows);
        }, 2000);
      });
    }
  ...
  displayMap: function displayMap(location, onSet) {
    return alert("Map");
  }
};
groupDesign = {
...
DemoLocationEditorComponent = /*#__PURE__*/function (_React$Component) {
  (0, _inherits2["default"])(DemoLocationEditorComponent, _React$Component);

  var _super = _createSuper(DemoLocationEditorComponent);
...
DemoComponent = /*#__PURE__*/function (_React$Component2) {
  (0, _inherits2["default"])(DemoComponent, _React$Component2);

  var _super2 = _createSuper(DemoComponent);
  ...
  (0, _createClass2["default"])(DemoComponent, [{
    ...
    value: function render() {
      ...
      schema = new FormSchemaBuilder({
        user: "bob"
      }).addForm(schema, design); // schema = new CustomTablesetSchemaBuilder().addTableset(schema, cascadingRefCustomTableset)
