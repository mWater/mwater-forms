...
class DemoComponent extends react_1.default.Component {
    ...
    render() {
        ...
        schema = new FormSchemaBuilder_1.default({ user: "bob" }).addForm(schema, design);
...
DemoComponent = (0, react_dnd_1.DragDropContext)(react_dnd_html5_backend_1.default)(DemoComponent);
...
react_dom_1.default.render(R(DemoComponent), document.getElementById("main"));
