var DemoComponent, FormComponent, FormSchemaBuilder, H, ImageUploaderModalComponent, ImageUploaderTestComponent, ItemListComponent, R, React, ReactDOM, ResponseDisplayComponent, Schema, canada, formCtx, manitoba, matrixFormDesign, ontario, rosterFormDesign, sampleForm2, sampleFormDesign, testStickyStorage,
...
DemoComponent = (function(superClass) {
  ...
  DemoComponent.prototype.render = function() {
    ...
    schema = new FormSchemaBuilder().addForm(schema, {
      _id: "form1",
      design: design
    });
    return H.div({
...
ImageUploaderTestComponent = (function(superClass) {
  extend(ImageUploaderTestComponent, superClass);

  function ImageUploaderTestComponent() {
    return ImageUploaderTestComponent.__super__.constructor.apply(this, arguments);
  }

  ImageUploaderTestComponent.prototype.render = function() {
  ...
  return ImageUploaderTestComponent;

})(React.Component);

$(function() {
  return ReactDOM.render(R(ImageUploaderTestComponent), document.getElementById("main"));
});
