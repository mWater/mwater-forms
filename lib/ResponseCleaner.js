...
module.exports = ResponseCleaner = (function() {
  ...
  ResponseCleaner.prototype.cleanData = function(design, visibilityCalculator, defaultValueApplier, data, oldVisibilityStructure, callback) {
    ...
    return async.whilst((function() {
      ...
      return function(cb) {
        return visibilityCalculator.createVisibilityStructure(newData, function(error, visibilityStructure) {
          if (error) {
            return cb(error);
          }
