var EntityAnswerComponent, EntityDisplayComponent, EntityLoadingComponent, EntityQuestion, H, Question, React, _,
...
module.exports = EntityQuestion = (function(superClass) {
  ...
  EntityQuestion.prototype.updateAnswer = function(answerEl) {
    ...
    return React.render(elem, answerEl.get(0));
  };

  EntityQuestion.prototype.remove = function() {
    if (this.answerEl) {
      React.unmountComponentAtNode(this.answerEl.get(0));
    }
