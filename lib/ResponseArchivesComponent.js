...
class ResponseArchivesComponent extends react_1.default.Component {
    constructor() {
        ...
        this.renderRecord = (record, previousRecord) => {
            var _a;
            return R("div", { key: record._rev, style: { marginTop: 10 } }, R("p", { key: "summary" }, "Changes made by ", R("b", null, record.modified.by ? (_a = this.props.eventsUsernames[record.modified.by]) === null || _a === void 0 ? void 0 : _a.username : "Anonymous"), " on ", moment_1.default(record.modified.on).format("lll")), R("div", { key: "detail" }, R(ResponseAnswersComponent_1.default, {
