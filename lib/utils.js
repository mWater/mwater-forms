...
exports.getRelativeLocation = function (fromLoc, toLoc) {
  ...
  y1 = fromLoc.latitude;
  x2 = toLoc.longitude;
  y2 = toLoc.latitude; // Convert to relative position (approximate)

  dy = (y2 - y1) / 57.2957795 * 6371000;
  dx = Math.cos(y1 / 57.2957795) * (x2 - x1) / 57.2957795 * 6371000; // Determine direction and angle
...
exports.getCompassBearing = function (angle, T) {
  var compassDir, compassStrs; // Get approximate direction
...
exports.calculateGPSStrength = function (pos) {
  ...
  excellentAcc = 5;
  goodAcc = 10;
  fairAcc = 50; // Recent is 90 seconds because some devices update only once per minute if no movement
...
exports.formatGPSStrength = function (pos, T) {
