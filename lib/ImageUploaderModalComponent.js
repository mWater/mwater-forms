...
class ImageUploaderModalComponent extends react_1.default.Component {
    ...
    renderContents() {
        ...
        })), R("div", { style: { display: !this.state.xhr ? "none" : undefined } }, R("p", null, R("em", null, this.props.T("Uploading Image..."))), R("div", { className: "progress progress-bar-striped active" }, R("div", { className: "progress-bar", style: { width: `${this.state.percentComplete}%` } })))), this.state.xhr
