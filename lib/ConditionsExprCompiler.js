...
conditionUtils = require('./conditionUtils'); // Compiles conditions into mWater expressions

module.exports = ConditionsExprCompiler = /*#__PURE__*/function () {
  function ConditionsExprCompiler(formDesign) {
    (0, _classCallCheck2["default"])(this, ConditionsExprCompiler);
    var i, item, len, ref;
    this.formDesign = formDesign; // Index all items
  ...
  (0, _createClass2["default"])(ConditionsExprCompiler, [{
    ...
    value: function compileConditions(conditions, tableId) {
      ...
      for (i = 0, len = conditions.length; i < len; i++) {
        ...
        if (cond.op === "present") {
              ...
              exprs.push({
                ...
                exprs: [{
                  ...
                  exprs: [{
                    table: tableId,
                    type: "field",
                    column: "data:".concat(item._id, ":value")
                  }]
                }, {
                  table: tableId,
                  type: "op",
              ...
              exprs.push({
                ...
                exprs: [{
                  ...
                  exprs: [{
                    table: tableId,
                    type: "field",
                    column: "data:".concat(item._id, ":value:cbt:mpn")
                  }]
                }, {
                  table: tableId,
                  type: "op",
                  ...
                  exprs: [{
                    table: tableId,
                    type: "field",
                    column: "data:".concat(item._id, ":value:image")
                  }]
                }]
              });
              break;
            ...
            case "units":
              exprs.push({
                ...
                exprs: [{
                  table: tableId,
                  type: "field",
                  column: "data:".concat(item._id, ":value:quantity")
                }]
              });
              break;
          ...
          if ((ref = cond.rhs.literal) === 'na' || ref === 'dontknow') {
            exprs.push({
              ...
              exprs: [{
                table: tableId,
                type: "field",
                column: "data:".concat(item._id, ":").concat(cond.rhs.literal)
              }]
            });
          } else {
            exprs.push({
            ...
            if (values.length === 0 && alternates.length === 1) {
              exprs.push({
                ...
                exprs: [{
                  table: tableId,
                  type: "field",
                  column: "data:".concat(item._id, ":").concat(alternates[0])
                }]
              });
                ...
                exprs: _.map(alternates, function (alt) {
                  return {
                    ...
                    exprs: [{
                      table: tableId,
                      type: "field",
                      column: "data:".concat(item._id, ":").concat(alt)
                    }]
                  };
                })
              });
          ...
          if (type === "choice" || values.length === 0) {
            subexprs = []; // All alternates have to be null
