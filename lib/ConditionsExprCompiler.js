var ConditionsExprCompiler, _, formUtils;
...
module.exports = ConditionsExprCompiler = (function() {
  ...
  ConditionsExprCompiler.prototype.compileConditions = function(conditions, tableId) {
    var alt, alternates, cond, exprs, i, item, j, k, l, len, len1, len2, len3, len4, len5, len6, m, n, o, ref, ref1, ref2, ref3, ref4, ref5, rhsType, subexprs, type, value, values;
    ...
    for (i = 0, len = conditions.length; i < len; i++) {
      ...
      if (cond.op === "present") {
        ...
        if (type === "choice") {
          ...
          subexprs = [];
          for (n = 0, len5 = values.length; n < len5; n++) {
            value = values[n];
            subexprs.push({
              table: tableId,
              type: "op",
          ...
          for (o = 0, len6 = alternates.length; o < len6; o++) {
            alt = alternates[o];
            subexprs.push({
              table: tableId,
              type: "field",
