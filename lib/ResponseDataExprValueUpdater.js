...
module.exports = ResponseDataExprValueUpdater = (function() {
  ...
  ResponseDataExprValueUpdater.prototype.cleanData = function(data, responseRowFactory, callback) {
    ...
    return responseCleaner.cleanData(this.formDesign, visibilityCalculator, null, data, responseRowFactory, null, (function(_this) {
