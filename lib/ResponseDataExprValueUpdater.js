...
module.exports = ResponseDataExprValueUpdater = function () {
  function ResponseDataExprValueUpdater(formDesign, schema, dataSource) {
    (0, _classCallCheck3.default)(this, ResponseDataExprValueUpdater);
  ...
  (0, _createClass3.default)(ResponseDataExprValueUpdater, [{
    key: 'canUpdate',
    ...
    value: function updateData(data, expr, value, callback) {
      ...
      return callback(new Error('Cannot update expr ' + (0, _stringify2.default)(expr)));
    }
