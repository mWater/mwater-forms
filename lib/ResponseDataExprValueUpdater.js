...
module.exports = ResponseDataExprValueUpdater = (function() {
  ...
  ResponseDataExprValueUpdater.prototype.cleanData = function(data, callback) {
    var visibilityCalculator;
    visibilityCalculator = new VisibilityCalculator(this.formDesign);
    return visibilityCalculator.createVisibilityStructure(data, (function(_this) {
      return function(error, visibilityStructure) {
        ...
        return responseCleaner.cleanData(_this.formDesign, visibilityCalculator, null, data, {}, function(error, results) {
  ...
  ResponseDataExprValueUpdater.prototype.validateData = function(data, callback) {
    var visibilityCalculator;
    visibilityCalculator = new VisibilityCalculator(this.formDesign);
    return visibilityCalculator.createVisibilityStructure(data, (function(_this) {
      return function(error, visibilityStructure) {
