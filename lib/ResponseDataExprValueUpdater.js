...
module.exports = ResponseDataExprValueUpdater =
/*#__PURE__*/
function () {
  ...
  (0, _createClass2["default"])(ResponseDataExprValueUpdater, [{
    ...
    value: function updateCascadingList(data, expr, value, callback) {
      var _value, column, field, question, questionId, ref;
      ...
      if (!_.find(question.columns, {
        id: column
      })) {
        return callback(new Error("Column ".concat(column, " in question ").concat(expr.column, " not found")));
      }

      _value = ((ref = data[questionId]) != null ? ref.value : void 0) || {};
      _value[column] = value;
      return callback(null, this.setValue(data, question, _value));
