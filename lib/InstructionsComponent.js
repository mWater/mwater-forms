...
module.exports = InstructionsComponent = (function(superClass) {
  ...
  InstructionsComponent.prototype.render = function() {
    var html, text;
    text = (this.context.formExprEvaluator || new FormExprEvaluator()).renderString(this.props.instructions.text, this.props.instructions.textExprs, this.props.data, this.context.locale);
