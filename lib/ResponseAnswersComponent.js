...
class ResponseAnswersComponent extends AsyncLoadComponent_1.default {
    ...
    renderLocation(location, showAdminRegion = false) {
        if (location) {
            return R("div", null, R("a", { onClick: this.handleLocationClick.bind(this, location), style: { cursor: "pointer" } }, `${location.latitude}\u00B0 ${location.longitude}\u00B0`, location.accuracy != null ? `(+/-) ${location.accuracy.toFixed(3)} m` : undefined, location.method ? ` (${location.method})` : undefined), showAdminRegion && this.props.renderAdminRegionForLocation
        ...
        switch (formUtils.getAnswerType(q)) {
            ...
            case "date":
                ...
                if (answer.value.length <= 7) {
                    ...
                    // Date
                    return R("div", null, (0, moment_1.default)(answer.value).format("LL"));
                }
                else {
                    return R("div", null, (0, moment_1.default)(answer.value).format("LLL"));
                }
            case "units":
                if (answer.value &&
            ...
            case "location":
                return this.renderLocation(answer.value, q.calculateAdminRegion);
            case "image":
                if (answer.value) {
            ...
            case "ranked":
                const sortedChoices = lodash_1.default.sortBy(q.choices, (item) => { var _a; return (_a = answer.value[item.id]) !== null && _a !== void 0 ? _a : 0; });
                const items = sortedChoices.map((choice, index) => R("li", { key: index }, formUtils.localizeString(choice.label, this.props.locale)));
                return R("ol", {}, items);
            case "asset":
                return this.props.formCtx.renderAssetSummaryView
                    ? this.props.formCtx.renderAssetSummaryView(q.assetSystemId, answer.value)
                    : null;
        }
        return null;
    }
    ...
    renderLikertAnswer(q, answer, prevAnswer) {
        ...
        if (formUtils.getAnswerType(q) === "items_choices") {
            ...
            for (let item of likertQuestion.items) {
                ...
                if (choiceId != null) {
                    let choice = lodash_1.default.findWhere(likertQuestion.choices, { id: choiceId });
                    if (choice != null) {
                    ...
                    if (this.props.showPrevAnswers && prevAnswer) {
                        ...
                        if (choiceId != null) {
                            choice = lodash_1.default.findWhere(likertQuestion.choices, { id: choiceId });
                            if (choice != null) {
                                contents.push(R("tr", null, itemTd, R("td", null, formUtils.localizeString(choice.label, this.props.locale))));
                            }
                            else {
    ...
    renderQuestion(q, dataId) {
        ...
        return [
            R("tr", trProps, R("td", { key: "name", style: { width: "50%" } }, formUtils.localizeString(q.text, this.props.locale)), R("td", { key: "value" }, R("div", null, likertAnswer == null ? this.renderAnswer(q, answer) : undefined, (() => {
                if (answer && answer.timestamp) {
                    this.props.T("Answered");
                    (": ");
                    return (0, moment_1.default)(answer.timestamp).format("llll");
                }
                return null;
                ...
                ? R("a", {
                    ...
                    key: "view_change"
                }, R(ui.Icon, { id: "fa-pencil-alt" }), " ", this.props.T("Edited"))
                ...
                ? R("td", { key: "prevValue" }, prevAnswer != null && !lodash_1.default.isEqual(prevAnswer.value, answer === null || answer === void 0 ? void 0 : answer.value) && this.props.onCompleteHistoryLinkClick
                    ...
                    : undefined, this.renderAnswer(q, prevAnswer), prevAnswer && prevAnswer.timestamp
                    ? R("div", null, this.props.T("Answered"), ": ", (0, moment_1.default)(prevAnswer.timestamp).format("llll"))
    ...
    renderItem(item, visibilityStructure, dataId) {
        ...
        if (item._type === "RosterMatrix" || item._type === "RosterGroup") {
            ...
            const data = this.props.data[item._id];
    ...
    render() {
        ...
        return R("div", null, R("table", { className: "table table-bordered table-sm", style: { marginBottom: 0 } }, R("thead", null, R("tr", null, R("th", null, this.props.T("Question")), R("th", null, this.props.T("Answer")), this.props.showPrevAnswers ? R("th", null, this.props.T("Original Answer")) : undefined)), R("tbody", null, this.props.formDesign.contents.map(item => {
            ...
            ? R("div", { key: "calculations" }, R("h4", { className: "mt-4" }, this.props.T("Calculations")), R(CalculationsDisplayComponent_1.CalculationsDisplayComponent, {
                formDesign: this.props.formDesign,
                schema: this.props.schema,
