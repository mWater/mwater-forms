var AdminRegionDisplayComponent, AquagenxCBTDisplayComponent, AsyncLoadComponent, EntityDisplayComponent, H, ImageDisplayComponent, PropTypes, R, React, ResponseAnswersComponent, ResponseRow, VisibilityCalculator, _, ezlocalize, formUtils, moment,
...
module.exports = ResponseAnswersComponent = (function(superClass) {
  ...
  ResponseAnswersComponent.prototype.renderItem = function(item, visibilityStructure, dataId) {
    var answer, column, contents, data, entry, i, index, itemValue, items, j, len, len1, ref, ref1, referencedRoster, rowItem, rows;
  ...
  ResponseAnswersComponent.prototype.render = function() {
    ...
    }, H.tbody(null, _.map(this.props.formDesign.contents, (function(_this) {
      return function(item) {
