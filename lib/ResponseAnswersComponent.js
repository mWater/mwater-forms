...
module.exports = ResponseAnswersComponent = function () {
  var ResponseAnswersComponent = function (_AsyncLoadComponent) {
    _inherits(ResponseAnswersComponent, _AsyncLoadComponent);

    function ResponseAnswersComponent() {
      _classCallCheck(this, ResponseAnswersComponent);

      return _possibleConstructorReturn(this, (ResponseAnswersComponent.__proto__ || Object.getPrototypeOf(ResponseAnswersComponent)).apply(this, arguments));
    }

    _createClass(ResponseAnswersComponent, [{
      key: 'isLoadNeeded',
      ...
      value: function load(props, prevProps, callback) {
        ...
        return new VisibilityCalculator(props.formDesign).createVisibilityStructure(props.data, responseRow, function (error, visibilityStructure) {
          return callback({
            error: error,
        ...
        switch (formUtils.getAnswerType(q)) {
          ...
          case "choices":
            return _.map(answer.value, function (v) {
              ...
              if (choice) {
                return H.div(null, formUtils.localizeString(choice.label, _this2.props.locale), answer.specify != null && answer.specify[v] ? (": ", H.em(null, answer.specify[v])) : void 0);
              } else {
                return H.div({
                  className: "label label-danger"
                }, "Invalid Choice");
      ...
      value: function render() {
        ...
        }, H.thead(null, H.tr(null, H.th(null, "Question"), H.th(null, "Answer"), this.props.showPrevAnswers ? H.th(null, "Original Answer") : void 0)), H.tbody(null, _.map(this.props.formDesign.contents, function (item) {
