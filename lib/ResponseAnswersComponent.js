var AdminRegionDisplayComponent, AquagenxCBTDisplayComponent, AsyncLoadComponent, EntityDisplayComponent, H, ImageDisplayComponent, R, React, ResponseAnswersComponent, VisibilityCalculator, _, ezlocalize, formUtils, moment,
...
module.exports = ResponseAnswersComponent = (function(superClass) {
  ...
  ResponseAnswersComponent.prototype.load = function(props, prevProps, callback) {
    return new VisibilityCalculator(props.formDesign).createVisibilityStructure(props.data, (function(_this) {
