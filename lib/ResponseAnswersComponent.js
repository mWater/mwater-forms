...
CascadingRefDisplayComponent = require("./answers/CascadingRefDisplayComponent").CascadingRefDisplayComponent; // Displays the answers of a response in a table
    ...
    (0, _createClass2["default"])(ResponseAnswersComponent, [{
      ...
      value: function renderQuestion(q, dataId) {
        ...
        return [R('tr', trProps, R('td', {
          ...
          key: "value"
        }, R('div', null, matrixAnswer == null ? this.renderAnswer(q, answer, dataId) : void 0, answer && answer.timestamp ? (this.props.T('Answered'), ": ", moment(answer.timestamp).format('llll')) : void 0, answer && answer.location ? this.renderLocation(answer.location) : void 0, answer && answer.comments ? R('div', {
