...
module.exports = ResponseAnswersComponent = (function(superClass) {
  ...
  ResponseAnswersComponent.contextTypes = {
  ...
  ResponseAnswersComponent.prototype.renderAnswer = function(q, answer) {
    ...
    if (answer.alternate) {
      switch (answer.alternate) {
        case "na":
          return H.em(null, this.context.T("Not Applicable"));
        case "dontknow":
          return H.em(null, this.context.T("Don't Know"));
      }
    }
    ...
    switch (formUtils.getAnswerType(q)) {
      ...
      case "boolean":
        if (answer.value) {
          return this.context.T("True");
        } else {
          return this.context.T("False");
        }
      case "location":
  ...
  ResponseAnswersComponent.prototype.renderQuestion = function(q, dataId) {
    ...
    return H.tr({
      ...
      key: "value"
    }, this.renderAnswer(q, answer), answer && answer.timestamp ? H.div(null, this.context.T('Answered'), ": ", moment(answer.timestamp).format('llll')) : void 0, answer && answer.location ? this.renderLocation(answer.location) : void 0));
  };
      ...
      return [
        H.tr({
          ...
          if (item.rosterId != null) {
            ...
            }, this.context.T("Data is stored in {0}", formUtils.localizeString(referencedRoster.name, this.props.locale)))));
          } else {
