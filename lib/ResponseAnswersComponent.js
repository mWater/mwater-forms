...
var AdminRegionDisplayComponent, AquagenxCBTDisplayComponent, AsyncLoadComponent, EntityDisplayComponent, ImageDisplayComponent, PropTypes, R, React, ResponseAnswersComponent, ResponseRow, TextExprsComponent, VisibilityCalculator, _, ezlocalize, formUtils, moment, ui;
...
AquagenxCBTDisplayComponent = require('./answers/AquagenxCBTDisplayComponent'); // Displays the answers of a response in a table

module.exports = ResponseAnswersComponent = function () {
  var ResponseAnswersComponent =
  /*#__PURE__*/
  function (_AsyncLoadComponent) {
    ...
    function ResponseAnswersComponent() {
      ...
      return (0, _possibleConstructorReturn2["default"])(this, (0, _getPrototypeOf2["default"])(ResponseAnswersComponent).apply(this, arguments));
    }
    ...
    (0, _createClass2["default"])(ResponseAnswersComponent, [{
      ...
      value: function renderLocation(location) {
        if (location) {
          ...
          }, "".concat(location.latitude, "\xB0 ").concat(location.longitude, "\xB0"), location.accuracy ? "(+/-) ".concat(location.accuracy, " m") : void 0));
        }
      }
    }, {
      key: "renderAnswer",
      value: function renderAnswer(q, answer, dataId) {
        var _this = this;

        var answerType, choice, choiceId, code, dataIds, entityType, i, item, label, len, ref, rosterEntryIndex, rosterId, siteType, specify, target, units, unitsStr, valueStr;
        answerType = formUtils.getAnswerType(q);

        if (!answer && answerType !== "expr") {
          return null;
        } // Handle alternates


        if (answer != null ? answer.alternate : void 0) {
        ...
        if ((answer != null ? answer.confidential : void 0) != null) {
          return R('em', null, T("Redacted"));
        }

        if ((answer != null ? answer.value : void 0) == null && answerType !== "expr") {
          return null;
        }
      ...
      value: function renderQuestion(q, dataId) {
        var answer, dataIds, matrixAnswer, prevAnswer, prevRosterData, ref, ref1, rosterData, trProps; // Get answer
        ...
        matrixAnswer = this.renderMatrixAnswer(q, answer, prevAnswer); // If both answer and previous answer are falsy
        ...
        return [R('tr', trProps, R('td', {
          ...
          key: "value"
        }, R('div', null, matrixAnswer == null ? this.renderAnswer(q, answer, dataId) : void 0, answer && answer.timestamp ? (this.props.T('Answered'), ": ", moment(answer.timestamp).format('llll')) : void 0, answer && answer.location ? this.renderLocation(answer.location) : void 0, prevAnswer != null && !_.isEqual(prevAnswer.value, answer != null ? answer.value : void 0) && this.props.showChangedLink ? R('a', {
          style: {
            "float": 'right',
