...
module.exports = ResponseAnswersComponent = (function(superClass) {
  ...
  ResponseAnswersComponent.prototype.renderQuestion = function(q, dataId) {
    var answer, dataIds, matrixAnswer, prevAnswer, prevRosterData, rosterData, trProps;
    ...
    if (prevAnswer) {
      if (!_.isEqual(prevAnswer.value, answer != null ? answer.value : void 0)) {
    ...
    return [
      H.tr(trProps, H.td({
        ...
        key: "prevValue"
      }, (prevAnswer != null) && !_.isEqual(prevAnswer.value, answer.value) && this.props.onCompleteHistoryLinkClick ? H.a({
        style: {
          float: 'right',
          display: 'inline-block',
          cursor: 'pointer',
