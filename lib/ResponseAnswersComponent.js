var AdminRegionDisplayComponent, AquagenxCBTDisplayComponent, EntityDisplayComponent, H, ImageDisplayComponent, R, React, ResponseAnswersComponent, VisibilityCalculator, ezlocalize, formUtils, moment,
...
module.exports = ResponseAnswersComponent = (function(superClass) {
  ...
  ResponseAnswersComponent.prototype.render = function() {
    ...
    visibilityStructure = new VisibilityCalculator(this.props.formDesign).createVisibilityStructure(this.props.data);
    return H.table({
