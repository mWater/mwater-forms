...
class ResponseAnswersComponent extends AsyncLoadComponent_1.default {
    ...
    render() {
        ...
        return R("div", null, R("table", { className: "table table-bordered table-sm", style: { marginBottom: 0 } }, R("thead", null, R("tr", null, R("th", null, "Question"), R("th", null, "Answer"), this.props.showPrevAnswers ? R("th", null, "Original Answer") : undefined)), R("tbody", null, lodash_1.default.map(this.props.formDesign.contents, (item) => {
