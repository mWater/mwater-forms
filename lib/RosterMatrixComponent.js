var AnswerValidator, H, NumberAnswerComponent, R, React, RosterMatrixComponent, _, conditionsUtils, formUtils,
...
module.exports = RosterMatrixComponent = (function(superClass) {
  ...
  RosterMatrixComponent.prototype.renderCell = function(entry, entryIndex, column, columnIndex) {
    var className, elem, key, ref, ref1, value;
    value = (ref = this.getAnswer()[entryIndex].data) != null ? (ref1 = ref[column._id]) != null ? ref1.value : void 0 : void 0;
    switch (column._type) {
