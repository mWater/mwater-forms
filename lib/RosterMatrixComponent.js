var H, NumberInputComponent, R, React, RosterMatrixComponent, _, formUtils,
...
module.exports = RosterMatrixComponent = (function(superClass) {
  ...
  RosterMatrixComponent.prototype.renderHeader = function() {
    return H.thead(null, _.map(this.props.rosterMatrix.columns, (function(_this) {
