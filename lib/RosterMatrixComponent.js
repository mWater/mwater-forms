var AnswerValidator, H, NumberAnswerComponent, R, React, RosterMatrixComponent, UnitsAnswerComponent, _, conditionsUtils, formUtils,
...
module.exports = RosterMatrixComponent = (function(superClass) {
  ...
  RosterMatrixComponent.prototype.areConditionsValid = function(choice) {
  ...
  RosterMatrixComponent.prototype.renderCell = function(entry, entryIndex, column, columnIndex) {
    var answer, cellText, className, data, elem, key, ref, value;
    answer = this.getAnswer()[entryIndex];
    data = answer.data;
    value = data != null ? (ref = data[column._id]) != null ? ref.value : void 0 : void 0;
    switch (column._type) {
      case "TextColumn":
        cellText = this.props.formExprEvaluator.renderString(column.cellText, column.cellTextExprs, data, this.props.data, this.context.locale);
        elem = H.label(null, cellText);
        break;
      case "UnitsColumnQuestion":
        console.log(column);
        console.log(answer);
        answer = data != null ? data[column._id] : void 0;
