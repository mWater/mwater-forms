...
exports.default = RosterMatrixComponent = (function () {
    RosterMatrixComponent = class RosterMatrixComponent extends react_1.default.Component {
        constructor(props) {
            super(props);
            ...
            this.renderEntry = (entry, index, connectDragSource, connectDragPreview, connectDropTarget) => {
                const elem = R("tr", { key: index }, lodash_1.default.map(this.props.rosterMatrix.contents, (column, columnIndex) => this.renderCell(entry, index, column, columnIndex)), this.props.rosterMatrix.allowRemove
                    ? R("td", { key: "_remove" }, R("button", { type: "button", className: "btn btn-sm btn-link", onClick: this.handleRemove.bind(null, index) }, R("span", { className: "glyphicon glyphicon-remove" })))
                    : undefined);
        ...
        static initClass() {
            ...
            this.propTypes = {
                rosterMatrix: prop_types_1.default.object.isRequired,
                data: prop_types_1.default.object,
                onDataChange: prop_types_1.default.func.isRequired,
                isVisible: prop_types_1.default.func.isRequired,
        ...
        renderAdd() {
            if (this.props.rosterMatrix.allowAdd) {
                return R("div", { key: "add", style: { marginTop: 10 } }, R("button", { type: "button", className: "btn btn-primary", onClick: this.handleAdd }, R("span", { className: "glyphicon glyphicon-plus" }), " " + this.context.T("Add")));
            }
        }
        renderBody() {
