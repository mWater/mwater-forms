...
module.exports = VisibilityEntity = (function() {
  ...
  VisibilityEntity.prototype.processGroupOrSection = function(groupOrSection, data) {
    ...
    if ((groupOrSection.conditions != null) && groupOrSection.conditions.length > 0) {
      conditions = this.compileConditions(groupOrSection.conditions, this.forms);
  ...
  VisibilityEntity.prototype.processItem = function(item, forceToInvisible, data, prefix) {
    if (formUtils.isQuestion(item)) {
      ...
      return this.processRosterGroup(item, forceToInvisible, data, prefix);
