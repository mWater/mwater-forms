        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (columnId.match(/^data:/)) {
                ...
                if (parts.length === 3 && parts[2] === "value") {
                    ...
                    // Get type of answer
                    const question = formUtils_1.default.findItem(this.formDesign, parts[1]);
                    if (!question) {
                        return null;
                    }
                ...
                // Specify
                if (parts[2] === "specify") {
                    return nullify(data[parts[1]] && data[parts[1]].specify != null && data[parts[1]].specify[parts[3]] != null ? data[parts[1]].specify[parts[3]] : null);
                }
                // Comments
                if (parts[2] === "comments") {
