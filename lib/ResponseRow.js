...
var ResponseRow = /** @class */ (function () {
    ...
    ResponseRow.prototype.getField = function (columnId) {
        return __awaiter(this, void 0, void 0, function () {
            var code, entityType, i, len, part, ref, ref1, ref10, ref11, ref12, ref13, ref14, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, siteType, value, visibilityCalculator, data, parts_1, visibilityCalculator_1, visibilityStructure, value_1, question_1, answerType, entityType_1, code_1, entity, entity, tableId, customRow, _i, _a, part_1, location_1, location_2, location_3;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        if (!columnId.match(/^data:/)) return [3 /*break*/, 13];
                        ...
                        if (!(parts_1.length === 3 && parts_1[2] === "visible")) return [3 /*break*/, 2];
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, visibilityStructure[parts_1[1]]];
                    case 2:
                        if (!(parts_1.length === 3 && parts_1[2] === "value")) return [3 /*break*/, 12];
                        value_1 = data[parts_1[1]] ? data[parts_1[1]].value : null;
                        // Null "" and []
                        ...
                        if (answerType === "date") {
                            ...
                            if (!question_1.format.match(/ss|LLL|lll|m|h|H/)) {
                    ...
                    case 5:
                        if (!(answerType === "entity")) return [3 /*break*/, 8];
                        if (!value_1) return [3 /*break*/, 7];
                        return [4 /*yield*/, new Promise(function (resolve, reject) {
                                _this.getEntityById(question_1.entityType, value_1, lodash_1.default.once(function (entity) {
                                    if (entity) {
                                        resolve(entity);
                                    }
                                    else {
                                        console.log("Warning: Entity " + value_1 + " not found in ResponseRow");
                                        resolve(null);
                                    }
                                }));
                            })];
                    ...
                    case 8:
                        if (!(answerType == "cascading_ref")) return [3 /*break*/, 11];
                        if (!value_1) return [3 /*break*/, 10];
                        tableId = question_1.tableId;
                        return [4 /*yield*/, this.getCustomTableRow(tableId, value_1)];
                    case 9:
                        customRow = _b.sent();
                        if (customRow) {
                    ...
                    case 12:
                        ...
                        if (parts_1[2] === "value") {
                            value = data[parts_1[1]] ? data[parts_1[1]].value : null;
                            for (_i = 0, _a = lodash_1.default.drop(parts_1, 3); _i < _a.length; _i++) {
                                part_1 = _a[_i];
                                value = value != null ? value[part_1] : null;
                            }
                            return [2 /*return*/, nullify(value)];
                        }
                        // Specify
                        if (parts_1[2] === "specify") {
                            return [2 /*return*/, nullify(data[parts_1[1]] && data[parts_1[1]].specify != null && data[parts_1[1]].specify[parts_1[3]] != null ? data[parts_1[1]].specify[parts_1[3]] : null)];
                        }
                        // Comments
                        if (parts_1[2] === "comments") {
                            return [2 /*return*/, nullify(data[parts_1[1]] ? data[parts_1[1]].comments : null)];
                        }
                        ...
                        //   return callback(null, data[parts[1]]?.value?[parts[3]])
                        // Alternates
                        if (parts_1.length === 3 && (parts_1[2] === 'na' || parts_1[2] === 'dontknow')) {
                            return [2 /*return*/, data[parts_1[1]] ? data[parts_1[1]].alternate == parts_1[2] || null : null];
                        }
                        // Timestamp
                        if (parts_1.length === 3 && parts_1[2] === "timestamp") {
                            return [2 /*return*/, nullify(data[parts_1[1]] ? data[parts_1[1]].timestamp : null)];
                        }
                        // Location
                        if (parts_1.length === 3 && parts_1[2] === "location") {
                            location_1 = data[parts_1[1]] ? data[parts_1[1]].location : null;
                            if (location_1) {
                                return [2 /*return*/, {
                                        type: "Point",
                        ...
                        if (parts_1.length === 4 && parts_1[2] === "location" && parts_1[3] === "accuracy") {
                            location_2 = data[parts_1[1]] ? data[parts_1[1]].location : null;
                            if (location_2) {
                                return [2 /*return*/, nullify(location_2.accuracy)];
                            }
                            return [2 /*return*/, null];
                        }
                        if (parts_1.length === 4 && parts_1[2] === "location" && parts_1[3] === "altitude") {
                            location_3 = data[parts_1[1]] ? data[parts_1[1]].location : null;
                            if (location_3) {
