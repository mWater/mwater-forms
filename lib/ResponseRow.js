    ...
    if (columnId.match(/^data:/)) {
      ...
      if (parts.length === 3 && parts[2] === "value") {
        ...
        if (answerType === "site") {
          ...
          code = value.code;
          if (code) {
            this.getEntityByCode(entityType, code, _.once((function(_this) {
              return function(entity) {
                if (entity) {
                  ...
                  return callback(new Error("Site " + code + " not found"));
                }
              };
            })(this)));
          } else {
        ...
        if (answerType === "entity") {
          if (value) {
            this.getEntityById(question.entityType, value, _.once((function(_this) {
              return function(entity) {
                if (entity) {
                  return callback(null, new EntityRow({
                    entityType: entityType,
                  ...
                  return callback(new Error("Entity " + value + " not found"));
                }
              };
            })(this)));
          } else {
