...
var ExprEvaluator, ExprUtils, PropTypes, R, React, TextExprsComponent, _, async, d3Format, formUtils, markdown;
    ...
    (0, _createClass2["default"])(TextExprsComponent, [{
      ...
      value: function render() {
        ...
        if (this.props.markdown) {
          ...
          str = this.props.format ? d3Format.format(this.props.format)(str) : str;
