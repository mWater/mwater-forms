...
var ExprUtils, Markdown, PromiseExprEvaluator, PropTypes, R, React, TextExprsComponent, _, async, d3Format, formUtils;
...
Markdown = require("markdown-it"); // Displays a text string with optional expressions embedded in it that are computed

module.exports = TextExprsComponent = function () {
  var TextExprsComponent = /*#__PURE__*/function (_React$Component) {
    (0, _inherits2["default"])(TextExprsComponent, _React$Component);

    var _super = _createSuper(TextExprsComponent);
    ...
    (0, _createClass2["default"])(TextExprsComponent, [{
      ...
      value: function render() {
        ...
        if (this.props.markdown) {
          html = str ? new Markdown().render(str) : ""; // Make sure links are external
