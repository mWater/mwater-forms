...
module.exports = TextListQuestion = (function(superClass) {
  ...
  TextListQuestion.prototype.keydown = function(ev) {
    var id, index, items, nextInput;
  ...
  TextListQuestion.prototype.setFocus = function() {
    var firstInput;
    firstInput = this.$("#input_0");
    firstInput.focus();
