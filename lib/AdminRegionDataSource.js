...
$ = require('jquery'); // Gets the admin region information from an mWater server. Here as a convenience for creating the form context

module.exports = AdminRegionDataSource = /*#__PURE__*/function () {
  function AdminRegionDataSource(apiUrl) {
    (0, _classCallCheck2["default"])(this, AdminRegionDataSource);
  ...
  (0, _createClass2["default"])(AdminRegionDataSource, [{
    key: "getAdminRegionPath",
    value: function getAdminRegionPath(id, callback) {
      var query; // select _id as id, level as level, name as name, type as type from admin_regions as ar 
    ...
    value: function findAdminRegionByLatLng(lat, lng, callback) {
      var query; // select _id as id from admin_regions as ar
