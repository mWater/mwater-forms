...
module.exports = ItemComponent = (function(superClass) {
  ...
  ItemComponent.prototype.scrollToInvalid = function(alreadyFoundFirst) {
    if (this.refs.question != null) {
      return this.refs.question.scrollToInvalid(alreadyFoundFirst);
    }
    if (this.refs.rosterGroup != null) {
      return this.refs.rosterGroup.scrollToInvalid(alreadyFoundFirst);
    }
    return false;
  };
  ...
  ItemComponent.prototype.focus = function() {
    if (this.refs.question != null) {
      return this.refs.question.focus();
    }
    if (this.refs.rosterGroup != null) {
      return this.refs.rosterGroup.focus();
    }
    return false;
  };
