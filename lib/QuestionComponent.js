...
module.exports = QuestionComponent = (function(superClass) {
  ...
  QuestionComponent.prototype.renderHint = function() {
    H.div(null, this.props.question.hint ? H.div({
      className: "text-muted"
    }, formUtils.localizeString(this.props.question.hint, this.context.locale)) : void 0);
    if (this.context.disableConfidentialFields && this.props.question.confidential) {
      return H.div({
        className: "text-muted"
      }, this.context.T("Confidential answers may not be edited."));
    }
  };
    ...
    switch (this.props.question._type) {
      case "TextQuestion":
        return R(TextAnswerComponent, {
          ...
          onValueChange: readonly ? null : this.handleValueChange,
      ...
      case "NumberQuestion":
        return R(NumberAnswerComponent, {
          ref: "answer",
          value: answer.value,
          onChange: readonly ? null : this.handleValueChange,
      ...
      case "DropdownQuestion":
        return R(DropdownAnswerComponent, {
          ...
          onAnswerChange: readonly ? null : this.handleAnswerChange
        });
      case "LikertQuestion":
      ...
      case "ImageQuestion":
        return R(ImageAnswerComponent, {
          ref: "answer",
          image: answer.value,
          onImageChange: readonly ? null : this.handleValueChange,
      ...
      case "ImagesQuestion":
        return R(ImagesAnswerComponent, {
          ...
          onImagelistChange: readonly ? null : this.handleValueChange,
          consentPrompt: this.props.question.consentPrompt ? formUtils.localizeString(this.props.question.consentPrompt, this.context.locale) : void 0
        });
