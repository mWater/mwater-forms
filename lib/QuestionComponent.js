...
module.exports = QuestionComponent = (function(superClass) {
  ...
  QuestionComponent.prototype.scrollToInvalid = function(alreadyFoundFirst) {
    var validationError;
    validationError = new AnswerValidator().validate(this.props.question, this.props.answer);
    if (validationError != null) {
      if (!alreadyFoundFirst) {
  ...
  QuestionComponent.prototype.render = function() {
    var className;
    if (!this.context.isVisible(this.props.question._id)) {
      return null;
    }
    className = "question";
