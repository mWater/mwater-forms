...
module.exports = QuestionComponent = function () {
  var QuestionComponent = function (_React$Component) {
    (0, _inherits3.default)(QuestionComponent, _React$Component);

    function QuestionComponent(props) {
      (0, _classCallCheck3.default)(this, QuestionComponent);

      var _this = (0, _possibleConstructorReturn3.default)(this, (QuestionComponent.__proto__ || (0, _getPrototypeOf2.default)(QuestionComponent)).call(this, props));
    ...
    (0, _createClass3.default)(QuestionComponent, [{
          ...
          return _regenerator2.default.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                ...
                case 7:
                  _context.next = 9;
                  return new AnswerValidator(this.props.schema, this.props.responseRow).validate(this.props.question, this.getAnswer());
      ...
      value: function render() {
        ...
        }, T("This field is confidential and cannot be edited.")) : void 0, answer.confidential == null ? [this.renderAlternates(), this.renderValidationError()] : void 0, this.renderCommentsField());
      }
    }]);
