...
CascadingRefAnswerComponent = require('./answers/CascadingRefAnswerComponent').CascadingRefAnswerComponent; // Question component that displays a question of any type.
...
module.exports = QuestionComponent = function () {
  var QuestionComponent = /*#__PURE__*/function (_React$Component) {
    (0, _inherits2["default"])(QuestionComponent, _React$Component);

    var _super = _createSuper(QuestionComponent);
    ...
    (0, _createClass2["default"])(QuestionComponent, [{
          ...
          return _regenerator["default"].wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                ...
                case 8:
                  _context.next = 10;
                  return new AnswerValidator(this.props.schema, this.props.responseRow, this.context.locale).validate(this.props.question, this.getAnswer());
      ...
      value: function render() {
        ...
        return R('div', {
          className: className,
          "data-qn-id": this.props.question._id
