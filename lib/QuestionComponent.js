...
module.exports = QuestionComponent = (function(superClass) {
  ...
  QuestionComponent.prototype.renderPrompt = function() {
    ...
    }, this.props.question.code + ": ") : void 0, (this.context.formExprEvaluator || new FormExprEvaluator()).renderString(this.props.question.text, this.props.question.textExprs, this.props.data, this.context.locale), this.props.question.required ? H.span({
      className: "required"
