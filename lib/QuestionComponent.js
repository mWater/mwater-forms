        ...
        return _regenerator["default"].async(function validate$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 8:
                _context.next = 10;
                return _regenerator["default"].awrap(new AnswerValidator(this.props.schema, this.props.responseRow, this.context.locale).validate(this.props.question, this.getAnswer()));
