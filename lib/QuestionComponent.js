...
module.exports = QuestionComponent = (function(superClass) {
  ...
  QuestionComponent.prototype.validate = function(scrollToFirstInvalid) {
    var ref, ref1, validationError;
    if (((ref = this.refs.answer) != null ? typeof ref.validate === "function" ? ref.validate(scrollToFirstInvalid) : void 0 : void 0) != null) {
    ...
    if (!validationError && !((ref1 = this.refs.answer) != null ? typeof ref1.isValid === "function" ? ref1.isValid() : void 0 : void 0)) {
  ...
  QuestionComponent.prototype.handleAnswerChange = function(newAnswer) {
    ...
    if (this.props.question.recordLocation && (oldAnswer.location == null)) {
      ...
      locationFinder.getLocation((function(_this) {
        return function(loc) {
          if ((loc != null) && (_this.unmounted == null)) {
            newAnswer = _.clone(_this.getAnswer());
  ...
  QuestionComponent.prototype.renderPrompt = function() {
    ...
    }, this.props.question.code + ": ") : void 0, this.props.formExprEvaluator.renderString(this.props.question.text, this.props.question.textExprs, this.props.data, this.props.parentData, this.context.locale), this.props.question.required ? H.span({
      className: "required"
