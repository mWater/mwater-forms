...
module.exports = LocationView = function () {
  var LocationView = function (_Backbone$View) {
    (0, _inherits3.default)(LocationView, _Backbone$View);

    function LocationView(options) {
      (0, _classCallCheck3.default)(this, LocationView);

      var _this = (0, _possibleConstructorReturn3.default)(this, (LocationView.__proto__ || (0, _getPrototypeOf2.default)(LocationView)).call(this));

      _this.locationFound = _this.locationFound.bind(_this);
      ...
      _this.T = options.T || ezlocalize.defaultT;
      // Listen to location events
      _this.listenTo(_this.locationFinder, 'found', _this.locationFound);
      _this.listenTo(_this.locationFinder, 'error', _this.locationError);
      ...
      _this.listenTo(_this.currentPositionFinder, 'status', _this.render);
      // Start tracking location so that we get an accurate location quickly
      _this.locationFinder.startWatch();
    ...
    (0, _createClass3.default)(LocationView, [{
      key: 'remove',
      value: function remove() {
        this.settingLocation = false;
        this.locationFinder.stopWatch();
        this.currentPositionFinder.stop();
        return (0, _get3.default)(LocationView.prototype.__proto__ || (0, _getPrototypeOf2.default)(LocationView.prototype), 'remove', this).call(this);
      }
    }, {
      key: 'render',
