...
module.exports = LocationView = function () {
  var LocationView = function (_Backbone$View) {
    _inherits(LocationView, _Backbone$View);

    function LocationView(options) {
      _classCallCheck(this, LocationView);

      var _this = _possibleConstructorReturn(this, (LocationView.__proto__ || Object.getPrototypeOf(LocationView)).call(this));
    ...
    _createClass(LocationView, [{
      ...
      value: function remove() {
        ...
        return _get(LocationView.prototype.__proto__ || Object.getPrototypeOf(LocationView.prototype), 'remove', this).call(this);
      }
    }, {
      key: 'render',
