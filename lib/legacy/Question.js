...
module.exports = Question = (function(superClass) {
  ...
  Question.prototype.updateVisibility = function(e) {
    ...
    if (this.visible && !this.shownOnce) {
      this.shownOnce = true;
      this.shownFirstTime();
    }
    if (!this.visible && this.model.has(this.id)) {
      return this.model.unset(this.id);
    }
  };
  ...
  Question.prototype.render = function() {
    this.$el.html(require("./templates/Question.hbs")(this, {
      helpers: {
        T: this.T
      }
    }));
  ...
  Question.prototype.inputKeydown = function(ev) {
    if (ev.keyCode === 13 || ev.keyCode === 9) {
      if (this.options.format !== "multiline") {
        this.nextOrComments(ev);
        return ev.preventDefault();
      }
    }
  };

  Question.prototype.nextOrComments = function(ev) {
    var comments;
    if (this.options.commentsField) {
      ...
      ev.target.blur();
      return this.trigger('nextQuestion');
    }
  };

  Question.prototype.setFocus = function(offset) {
