...
class ImagePopupComponent extends AsyncLoadComponent_1.default {
    ...
    render() {
        ...
        return react_1.default.createElement(ModalPopupComponent_1.default, {
            footer: R("button", { type: "button", className: "btn btn-secondary", onClick: this.props.onClose }, this.props.T("Close"))
        }, R("div", null, R("button", { type: "button", className: "btn-close", onClick: this.props.onClose }), 
        // Add button links
