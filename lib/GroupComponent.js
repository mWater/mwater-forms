...
class GroupComponent extends react_1.default.Component {
    ...
    render() {
        return R("div", { className: "card" }, R("div", { key: "header", className: "card-header" }, formUtils.localizeString(this.props.group.name, this.context.locale)), R("div", { key: "body", className: "card-body" }, R(ItemListComponent_1.default, {
            ref: (c) => {
