...
module.exports = FormCompiler = (function() {
  ...
  FormCompiler.prototype.compileLoadLinkedAnswers = function(propertyLinks) {
    return (function(_this) {
      return function(entity) {
        var formEntityLinker, propLink, _i, _len, _results;
        if (!propertyLinks) {
          return;
        }
        formEntityLinker = new FormEntityLinker(entity, _this.model);
        _results = [];
        for (_i = 0, _len = propertyLinks.length; _i < _len; _i++) {
          propLink = propertyLinks[_i];
          _results.push(formEntityLinker.loadToForm(propLink));
        }
        return _results;
      };
    })(this);
  ...
  FormCompiler.prototype.compileSaveLinkedAnswers = function(propertyLinks, form) {
    return (function(_this) {
      return function() {
        var entity, formEntityLinker, isQuestionVisible, propLink, _i, _len;
        entity = {};
        if (form) {
        ...
        formEntityLinker = new FormEntityLinker(entity, _this.model, isQuestionVisible);
        for (_i = 0, _len = propertyLinks.length; _i < _len; _i++) {
          propLink = propertyLinks[_i];
