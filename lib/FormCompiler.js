var BarcodeQuestion, CheckQuestion, DateQuestion, DropdownQuestion, EntityQuestion, FormCompiler, FormControls, FormView, ImageQuestion, ImagesQuestion, Instructions, LocationQuestion, MulticheckQuestion, NumberQuestion, RadioQuestion, Section, Sections, SiteQuestion, TextListQuestion, TextQuestion, UnitsQuestion, ezlocalize, formUtils, markdown, _,
...
module.exports = FormCompiler = (function() {
        ...
        for (_i = 0, _len = propertyLinks.length; _i < _len; _i++) {
          ...
          switch (propLink.type) {
            ...
            case "boolean:choices":
              ...
              if (val === true) {
                ...
                if (_.contains(answer.value, propLink.choice)) {
                  ...
                  _results.push(_this.model.set(propLink.question, _.cloneDeep(answer)));
                } else {
                  _results.push(void 0);
                }
              }
            ...
            case "text:specify":
              ...
              if (!answer.specify[propLink.choice]) {
      ...
      return function() {
        ...
        for (_i = 0, _len = propertyLinks.length; _i < _len; _i++) {
          ...
          switch (propLink.type) {
            ...
            case "measurement:units":
              answer = _this.model.get(propLink.question) || {};
              if ((answer.value != null) && (answer.value.quantity != null)) {
                mapping = _.findWhere(propLink.mappings, {
  ...
  FormCompiler.prototype.compileForm = function(form) {
    ...
    options.getEntityUpdates = (function(_this) {
      return function() {
        var propertyUpdates, question, updates, _i, _len, _ref;
        updates = [];
        if (form.entitySettings && (formViewEntity != null)) {
          updates.push({
