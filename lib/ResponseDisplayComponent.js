var AdminRegionDisplayComponent, Backbone, EntityDisplayComponent, FormCompiler, H, ImageDisplayComponent, React, ResponseDisplayComponent, formUtils, moment,
...
module.exports = ResponseDisplayComponent = (function(superClass) {
  ...
  ResponseDisplayComponent.prototype.checkIfVisible = function(item) {
    ...
    conds = formCompiler.compileConditions(item.conditions, this.props.form.design);
    return conds();
  };
