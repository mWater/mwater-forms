...
module.exports = ResponseDisplayComponent = function () {
  var ResponseDisplayComponent = function (_React$Component) {
    _inherits(ResponseDisplayComponent, _React$Component);

    function ResponseDisplayComponent(props) {
      _classCallCheck(this, ResponseDisplayComponent);

      var _this = _possibleConstructorReturn(this, (ResponseDisplayComponent.__proto__ || Object.getPrototypeOf(ResponseDisplayComponent)).call(this, props));
    ...
    _createClass(ResponseDisplayComponent, [{
