...
module.exports = ResponseDisplayComponent = (function(superClass) {
  ...
  ResponseDisplayComponent.prototype.renderHistory = function() {
    var contents, ev, events, i, lastEvent, len;
    contents = [];
  ...
  ResponseDisplayComponent.prototype.renderHeader = function() {
    return H.div({
      ...
      key: "date"
    }, this.props.T('Date'), ": ", H.b(null, moment(this.props.response.modified.on).format('lll'))), this.renderStatus(), this.renderHistory());
  };
