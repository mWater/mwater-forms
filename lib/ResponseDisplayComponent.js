...
SiteDisplayComponent = (function(superClass) {
  ...
  SiteDisplayComponent.prototype.update = function(props) {
    ...
    if (this.props.formCtx.getSite) {
      return this.props.formCtx.getSite(this.props.siteCode, (function(_this) {
  ...
  SiteDisplayComponent.prototype.render = function() {
    ...
    return H.div(null, this.renderNameValue("Code", this.state.site.code), this.renderNameValue("Name", this.state.site.name), this.renderNameValue("Description", this.state.site.desc), this.state.site.type ? this.renderNameValue("Type", this.state.site.type.join(": ")) : void 0, this.state.site.photos ? this.renderNameValue("Photos", _.map(this.state.site.photos, (function(_this) {
      return function(img) {
        return React.createElement(ImageDisplayComponent, {
          formCtx: _this.props.formCtx,
          id: img.id
