...
const LocationQuestionAdminRegionComponent_1 = __importDefault(require("./LocationQuestionAdminRegionComponent"));
...
class ResponseDisplayComponent extends react_1.default.Component {
    constructor(props) {
        ...
        this.renderAdminRegionForLocation = (location) => {
            if (location)
                return R(LocationQuestionAdminRegionComponent_1.default, {
    ...
    loadEventUsernames(events) {
        ...
        if (byArray.length > 0 && this.props.apiUrl != null) {
            ...
            jquery_1.default.ajax({ dataType: "json", url })
                .done((rows) => {
    ...
    componentWillReceiveProps(nextProps) {
        ...
        if (!lodash_1.default.isEqual(this.props.response._id, nextProps.response._id)) {
    ...
    renderEvent(ev) {
        ...
        return R("div", null, eventType, " ", this.state.T("by"), " ", ev.by ? (_a = this.state.eventsUsernames[ev.by]) === null || _a === void 0 ? void 0 : _a.username : "Anonymous", " ", this.state.T("on"), " ", (0, moment_1.default)(ev.on).format("lll"), ev.message ? [": ", R("i", null, ev.message)] : undefined, ev.override ? R("span", { className: "badge bg-warning" }, this.state.T("Admin Override")) : undefined);
    }
    // History of events
    renderHistory() {
    ...
    renderHeader() {
        return R("div", { style: { paddingBottom: 10 } }, R("div", { key: "user" }, this.state.T("User"), ": ", R("b", null, this.props.response.username || "Anonymous")), R("div", { key: "code" }, this.state.T("Response Id"), ": ", R("b", null, this.props.response.code)), this.props.response && this.props.response.submittedOn
            ? R("div", { key: "submittedOn" }, this.state.T("Submitted"), ": ", R("b", null, (0, moment_1.default)(this.props.response.submittedOn).format("lll")))
    ...
    render() {
        return R("div", null, this.renderHeader(), react_1.default.createElement(ResponseAnswersComponent_1.default, {
            ...
            T: this.state.T,
            formCtx: this.props.formCtx,
            prevData: this.state.history && this.state.history.length > 0 ? lodash_1.default.last(this.state.history).data : undefined,
...
ResponseDisplayComponent.childContextTypes = lodash_1.default.extend({}, formContextTypes, {
