...
module.exports = ResponseDisplayComponent = (function(superClass) {
  ...
  ResponseDisplayComponent.prototype.renderEvent = function(ev) {
    ...
    return H.div(null, eventType, " ", this.state.T("by"), " ", (ref = this.state.eventsUsernames[ev.by]) != null ? ref.username : void 0, " ", this.state.T("on"), " ", moment(ev.on).format('lll'), ev.message ? [": ", H.i(null, ev.message)] : void 0, ev.override ? H.span({
