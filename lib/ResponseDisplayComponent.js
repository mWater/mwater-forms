var AdminRegionDisplayComponent, EntityDisplayComponent, H, ImageDisplayComponent, React, ResponseDisplayComponent, VisibilityCalculator, ezlocalize, formUtils, moment,
...
module.exports = ResponseDisplayComponent = (function(superClass) {
  ...
  ResponseDisplayComponent.prototype.componentWillReceiveProps = function(nextProps) {
    ...
    if (this.props.design !== nextProps.design || this.props.formCtx.locale !== nextProps.formCtx.locale) {
      return this.setState({
        T: this.createLocalizer(nextProps.design, nextProps.formCtx.locale)
      });
    }
  };
  ...
  ResponseDisplayComponent.prototype.renderAnswer = function(q, answer) {
    ...
    if (answer.alternate) {
      switch (answer.alternate) {
        case "na":
          return H.em(null, this.state.T("Not Applicable"));
        case "dontknow":
          return H.em(null, this.state.T("Don't Know"));
      }
    }
    ...
    switch (formUtils.getAnswerType(q)) {
      ...
      case "boolean":
        if (answer.value) {
          return this.state.T("True");
        } else {
          return this.state.T("False");
        }
      case "location":
  ...
  ResponseDisplayComponent.prototype.renderQuestion = function(q, dataId) {
    ...
    return H.tr({
      ...
      key: "value"
    }, this.renderAnswer(q, answer), answer && answer.timestamp ? H.div(null, this.state.T('Answered'), ": ", moment(answer.timestamp).format('llll')) : void 0, answer && answer.location ? this.renderLocation(answer.location) : void 0));
  };
      ...
      return [
        H.tr({
          ...
          if (item.rosterId != null) {
            ...
            }, this.state.T("Data is stored in {0}", referencedRoster.name[this.props.formCtx.locale]))));
          } else {
