    ...
    renderSetByGPS() {
        ...
        return (react_1.default.createElement("div", { id: "location_setter", className: "alert alert-warning" },
            react_1.default.createElement("div", null,
                ...
                " \u00A0",
                this.state.positionStatus.strength != "none" && this.state.positionStatus.strength != "good" ? (react_1.default.createElement("button", { type: "button", className: "btn btn-sm btn-default", style: { marginLeft: 5 }, disabled: !this.state.positionStatus.useable, onClick: this.handleUseAnyway },
