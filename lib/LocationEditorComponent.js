...
class LocationEditorComponent extends react_1.default.Component {
    constructor(props) {
        ...
        this.handleOpenAdvanced = () => { this.setState({ displayingAdvanced: true }); };
        this.handleCloseAdvanced = () => { this.setState({ displayingAdvanced: false, enteringManual: false }); };
        this.handleEnterManually = () => { this.setState({ enteringManual: true, manualLat: null, manualLng: null, manualAlt: null }); };
        this.handleManualLatChange = (value) => { this.setState({ manualLat: value }); };
        this.handleManualLngChange = (value) => { this.setState({ manualLng: value }); };
        this.handleManualAltChange = (value) => { this.setState({ manualAlt: value }); };
        ...
        this.handleCancelManual = () => { this.setState({ enteringManual: false }); };
