...
var LocationEditorComponent = /** @class */ (function (_super) {
    ...
    function LocationEditorComponent(props) {
        ...
        _this.handleSaveManual = function () {
            if (_this.state.manualLat >= 85 || _this.state.manualLat <= -85) {
                alert(_this.props.T("Latitude out of range"));
                return;
            }
            if (_this.state.manualLng >= 180 || _this.state.manualLng <= -180) {
                alert(_this.props.T("Longitude out of range"));
                return;
            }
