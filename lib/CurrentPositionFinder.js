var Backbone, CurrentPositionFinder, LocationFinder, goodDelay, initialDelay, utils, _,
...
module.exports = CurrentPositionFinder = (function() {
  function CurrentPositionFinder(options) {
    ...
    this.afterGoodDelay = __bind(this.afterGoodDelay, this);
    this.afterInitialDelay = __bind(this.afterInitialDelay, this);
    this.locationFinderError = __bind(this.locationFinderError, this);
    this.locationFinderFound = __bind(this.locationFinderFound, this);
  ...
  CurrentPositionFinder.prototype.updateStatus = function() {
    ...
    this.useable = (this.initialDelayComplete && ((_ref = this.strength) === "fair" || _ref === "poor")) || this.strength === "good";
