...
exports.priorQuestions = function(form, refItem) {
  var item, item2, j, k, len, len1, priors, ref, ref1;
  priors = [];
  ref = form.contents;
...
exports.findItem = function(form, questionId) {
  var item, item2, item3, j, k, l, len, len1, len2, len3, m, ref, ref1, ref2, ref3;
  ref = form.contents;
  for (j = 0, len = ref.length; j < len; j++) {
    item = ref[j];
    ...
    if (item._type === "Section") {
      ...
      for (k = 0, len1 = ref1.length; k < len1; k++) {
        ...
        if (item2._type === "Group" || item._type === "RosterGroup") {
          ref2 = item2.contents;
    ...
    if (item._type === "Group" || item._type === "RosterGroup") {
      ref3 = item.contents;
...
exports.duplicateItem = function(item, idMap) {
  ...
  if (dup.propertyLinks) {
    dup.propertyLinks = _.filter(dup.propertyLinks, (function(_this) {
      return function(link) {
        if (link.questionId) {
          if (idMap && idMap[link.questionId]) {
