...
exports.createMediumUid = function () {
  var chrs, i, id, j;
  chrs = "abcdefghjklmnpqrstuvwxyzABCDEFGHJKLMNPQRSTUVWXYZ123456789";
  id = "";
...
exports.isExpression = function (item) {
  var ref;
  return item._type != null && ((ref = item._type) === "TextColumn" || ref === "Calculation");
};
...
exports.getCustomTablesReferenced = function (formDesign) {
  var crqs, items, tableIds;
  items = exports.allItems(formDesign);
  crqs = _.filter(items, function (item) {
    return item._type === "CascadingRefQuestion";
  });
  return tableIds = _.uniq(_.pluck(crqs, "tableId"));
};