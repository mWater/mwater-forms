...
exports.prepareQuestion = function(q) {
  ...
  knownFields = ['_id', '_type', 'text', 'textExprs', 'conditions', 'validations', 'required', 'code', 'hint', 'help', 'alternates', 'commentsField', 'recordLocation', 'recordTimestamp', 'sticky', 'exportId', 'disabled'];
  switch (q._type) {
    case "TextQuestion":
    case "DateQuestion":
