...
exports.default = ResponseDataValidator = class ResponseDataValidator {
    ...
    validateParentItem(parentItem, visibilityStructure, data, schema, responseRow, keyPrefix) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            // Create validator
            const answerValidator = new AnswerValidator_1.default(schema, responseRow);
            // For each item
                    ...
                    if (item._type === "MatrixQuestion") {
                        for (let rowIndex = 0; rowIndex < item.items.length; rowIndex++) {
                            ...
                            for (let columnIndex = 0; columnIndex < item.columns.length; columnIndex++) {
                                ...
                                if (column.required && ((cellData === null || cellData === void 0 ? void 0 : cellData.value) == null || (cellData === null || cellData === void 0 ? void 0 : cellData.value) === "")) {
                                    return {
                                ...
                                if (column.validations && column.validations.length > 0) {
                                    const validationError = new ValidationCompiler_1.default().compileValidations(column.validations)(cellData);
                                    if (validationError) {
                                        return {
                                            questionId: completedId,
