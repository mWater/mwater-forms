...
function () {
  ...
  (0, _createClass2["default"])(ResponseDataValidator, [{
    ...
    value: function () {
      var _validateParentItem = (0, _asyncToGenerator2["default"])(
      /*#__PURE__*/
      _regenerator["default"].mark(function _callee(parentItem, visibilityStructure, data, schema, responseRow, keyPrefix) {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 17:
                ...
                _context.next = 21;
                return this.validateParentItem(item, visibilityStructure, entry.data, schema, responseRow, "".concat(keyPrefix).concat(answerId, ".").concat(index, "."));
