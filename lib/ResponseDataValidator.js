          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 17:
                ...
                _context.next = 21;
                return this.validateParentItem(item, visibilityStructure, entry.data, schema, responseRow.getRosterResponseRow(entry._id, index), "".concat(keyPrefix).concat(answerId, ".").concat(index, "."));
