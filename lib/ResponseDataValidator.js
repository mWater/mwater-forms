...
module.exports = ResponseDataValidator =
/*#__PURE__*/
function () {
  ...
  (0, _createClass2["default"])(ResponseDataValidator, [{
    ...
    value: function validateParentItem(parentItem, visibilityStructure, data, schema, responseRow, keyPrefix) {
      ...
      return _regenerator["default"].async(function validateParentItem$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 7:
              ...
              _context.next = 10;
              return _regenerator["default"].awrap(this.validateParentItem(item, visibilityStructure, data, schema, responseRow, keyPrefix));
            ...
            case 17:
              ...
              _context.next = 21;
              return _regenerator["default"].awrap(this.validateParentItem(item, visibilityStructure, entry.data, schema, responseRow, "".concat(keyPrefix).concat(answerId, ".").concat(index, ".")));
            ...
            case 56:
              _context.next = 58;
              return _regenerator["default"].awrap(answerValidator.validate(item, answer));
