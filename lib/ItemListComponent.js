var GroupComponent, H, InstructionsComponent, ItemListComponent, QuestionComponent, R, React, RosterGroupComponent, RosterMatrixComponent, _, formRenderUtils, formUtils,
...
module.exports = ItemListComponent = (function(superClass) {
  ...
  ItemListComponent.prototype.renderItem = function(item, index) {
    if (this.props.isVisible(item._id) && !item.disabled) {
      return formRenderUtils.renderItem(item, this.props.data, this.props.parentData, this.props.formExprEvaluator, this.props.onDataChange, this.props.isVisible, this.handleNext.bind(this, index));
    }
  };
