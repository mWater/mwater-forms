...
module.exports = VisibilityCalculator = (function() {
  ...
  VisibilityCalculator.prototype.processItem = function(item, forceToInvisible, data, responseRow, visibilityStructure, prefix, callback) {
    ...
    if (formUtils.isQuestion(item)) {
      ...
      return this.processInstruction(item, forceToInvisible, data, responseRow, visibilityStructure, prefix, callback);
    } else if (item._type === "Timer") {
      return this.processTimer(item, forceToInvisible, data, responseRow, visibilityStructure, prefix, callback);
  ...
  VisibilityCalculator.prototype.processInstruction = function(instruction, forceToInvisible, responseRow, data, visibilityStructure, prefix, callback) {
    return this.processQuestion(item, forceToInvisible, data, responseRow, visibilityStructure, prefix, callback);
  };

  VisibilityCalculator.prototype.processTimer = function(instruction, forceToInvisible, data, responseRow, visibilityStructure, prefix, callback) {
    return this.processQuestion(item, forceToInvisible, data, responseRow, visibilityStructure, prefix, callback);
  };
  ...
  VisibilityCalculator.prototype.processRoster = function(rosterGroup, forceToInvisible, data, responseRow, visibilityStructure, prefix, callback) {
    ...
    subData = data[dataId];
    if (subData != null) {
      return responseRow.getField("data:" + dataId, (function(_this) {
        return function(error, rosterRows) {
          if (error) {
            return callback(error);
          }
