...
class DateTimePickerComponent extends react_1.default.Component {
    ...
    render() {
        return (react_1.default.createElement("div", { className: "input-group", ref: this.inputRef },
            react_1.default.createElement("input", { type: "text", className: "form-control", placeholder: this.props.placeholder, ref: c => { this.textRef = c; }, onChange: ev => { }, onKeyDown: this.props.onKeyDown }),
