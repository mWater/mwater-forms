...
class BarcodeAnswerComponent extends react_1.default.Component {
    ...
    render() {
        ...
        if (this.props.value) {
            return R("div", null, R("pre", null, R("p", null, this.props.value)), R("div", null, R("button", { className: "btn btn-default", onClick: this.handleClearClick, type: "button" }, R("span", { className: "glyphicon glyphicon-remove" }, this.context.T("Clear")))));
        }
        else {
            if (supported) {
                return R("div", null, R("button", { className: "btn btn-default", onClick: this.handleScanClick, type: "button" }, R("span", { className: "glyphicon glyphicon-qrcode" }), this.context.T("Scan")));
            }
            else {
