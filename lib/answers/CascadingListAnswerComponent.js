...
var CascadingListAnswerComponent = /** @class */ (function (_super) {
    ...
    CascadingListAnswerComponent.prototype.renderDropdown = function (index) {
        ...
        return react_1.default.createElement("div", { style: { paddingBottom: 15 } },
            react_1.default.createElement("label", null, formUtils_1.localizeString(this.props.columns[index].name, this.props.locale)),
