var H, PropTypes, R, React, StopwatchAnswerComponent, getDisplayValue, integerDiv, now, toSeconds, toTicks, zeroPad,
...
module.exports = StopwatchAnswerComponent = (function(superClass) {
  ...
  function StopwatchAnswerComponent(props) {
    ...
    var ticks;
    StopwatchAnswerComponent.__super__.constructor.call(this, props);
