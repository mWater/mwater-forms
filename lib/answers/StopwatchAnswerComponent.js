...
module.exports = StopwatchAnswerComponent = function () {
  ...
  function (_React$Component) {
    ...
    function StopwatchAnswerComponent(props) {
      ...
      var ticks;
      _this = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(StopwatchAnswerComponent).call(this, props)); // Starts a timer to update @elapsedTicks every 10 ms
