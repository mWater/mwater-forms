...
class StopwatchAnswerComponent extends react_1.default.Component {
    ...
    render() {
        ...
        return R("div", {}, R("h1", { style: { fontFamily: "monospace" } }, getDisplayValue(this.state.elapsedTicks)), R("div", { className: "", role: "toolbar" }, R("div", { className: "btn-group", role: "group" }, R("button", { className: "btn btn-success", onClick: this.handleStartClick, disabled: isRunning }, this.props.T("Start")), R("button", { className: "btn btn-danger", onClick: this.handleStopClick, disabled: !isRunning }, this.props.T("Stop")), R("button", { className: "btn btn-secondary", onClick: this.handleResetClick, disabled: !this.state.elapsedTicks }, this.props.T("Reset")))));
    }
}
