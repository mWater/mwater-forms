...
module.exports = StopwatchAnswerComponent = function () {
  var StopwatchAnswerComponent = function (_React$Component) {
    (0, _inherits3.default)(StopwatchAnswerComponent, _React$Component);

    function StopwatchAnswerComponent(props) {
      (0, _classCallCheck3.default)(this, StopwatchAnswerComponent);

      var ticks;

      // Starts a timer to update @elapsedTicks every 10 ms
      var _this = (0, _possibleConstructorReturn3.default)(this, (StopwatchAnswerComponent.__proto__ || (0, _getPrototypeOf2.default)(StopwatchAnswerComponent)).call(this, props));
    ...
    (0, _createClass3.default)(StopwatchAnswerComponent, [{
