...
module.exports = DateAnswerComponent = function () {
  var DateAnswerComponent = function (_React$Component) {
    (0, _inherits3.default)(DateAnswerComponent, _React$Component);

    function DateAnswerComponent(props) {
      (0, _classCallCheck3.default)(this, DateAnswerComponent);

      var _this = (0, _possibleConstructorReturn3.default)(this, (DateAnswerComponent.__proto__ || (0, _getPrototypeOf2.default)(DateAnswerComponent)).call(this, props));
    ...
    (0, _createClass3.default)(DateAnswerComponent, [{
