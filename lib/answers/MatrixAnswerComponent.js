var AnswerValidator, H, MatrixAnswerComponent, MatrixColumnCellComponent, PropTypes, R, React, _, formUtils,
...
module.exports = MatrixAnswerComponent = (function(superClass) {
  ...
  function MatrixAnswerComponent(props) {
    ...
    MatrixAnswerComponent.__super__.constructor.call(this, props);
    this.state = {
      validationErrors: {}
    };
  }
