...
class TextListAnswerComponent extends react_1.default.Component {
    ...
    render() {
        ...
        }), R("span", { className: "input-group-btn" }, R("button", {
            className: "btn btn-link remove",
            "data-index": index,
            type: "button",
            onClick: this.handleRemoveClick.bind(null, index)
        }, R("span", { className: "glyphicon glyphicon-remove" }))))))), R("tr", null, R("td", null), R("td", null, R("div", { className: "input-group" }, R("input", {
            type: "text",
            className: "form-control box",
