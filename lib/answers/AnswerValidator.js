...
var AnswerValidator, PromiseExprEvaluator, ValidationCompiler, _, formUtils, siteCodes;
...
module.exports = AnswerValidator = /*#__PURE__*/function () {
  ...
  (0, _createClass2["default"])(AnswerValidator, [{
    key: "validate",
    value: function () {
      var _validate = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee(question, answer) {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 52:
                ...
                // Evaluate expression
                exprEvaluator = new PromiseExprEvaluator({
                  schema: this.schema
                });
                _context.next = 60;
