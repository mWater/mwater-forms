...
var CascadingRefAnswerComponent = /** @class */ (function (_super) {
    ...
    CascadingRefAnswerComponent.prototype.render = function () {
        ...
        if (!table) {
            ...
            return react_1.default.createElement("div", { className: "alert alert-danger" }, this.props.T("No data found for question. Please ensure that you are connected to internet for the first use of this form."));
        }
