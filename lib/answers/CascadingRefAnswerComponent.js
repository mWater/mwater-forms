...
class CascadingRefAnswerComponent extends react_1.default.Component {
    ...
    renderDropdown(index) {
        ...
        if (column.type == "enum" && column.enumValues) {
            for (const enumValue of lodash_1.default.sortBy(column.enumValues, (e) => e.name[e.name._base])) {
                // Add if in values
                if (values.includes(enumValue.id)) {
                    options.push({ value: enumValue.id, label: (0, formUtils_1.localizeString)(enumValue.name, this.props.locale) });
                }
            }
        }
        else {
        ...
        return (react_1.default.createElement("div", { style: { paddingBottom: 15 }, key: index },
            react_1.default.createElement("label", { className: "text-muted" }, (0, formUtils_1.localizeString)(dropdown.name, this.props.locale)),
            ...
            dropdown.hint ? react_1.default.createElement("div", { className: "text-muted" }, (0, formUtils_1.localizeString)(dropdown.hint, this.props.locale)) : null));
    }
    render() {
