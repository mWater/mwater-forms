  ...
  var AquagenxCBTDisplayComponent = function (_React$Component) {
    ...
    (0, _createClass3.default)(AquagenxCBTDisplayComponent, [{
      ...
      value: function renderStyle() {
        ...
        return R('style', null, mainId + ' #compartment1 rect { fill: ' + compartmentColors[0] + '; } ' + mainId + ' #compartment2 rect { fill: ' + compartmentColors[1] + '; } ' + mainId + ' #compartment3 rect { fill: ' + compartmentColors[2] + '; } ' + mainId + ' #compartment4 rect { fill: ' + compartmentColors[3] + '; } ' + mainId + ' #compartment5 rect { fill: ' + compartmentColors[4] + '; }');
      }
    }, {
      key: 'renderInfo',
