...
module.exports = ImageAnswerComponent = function () {
  var ImageAnswerComponent = /*#__PURE__*/function (_React$Component) {
    (0, _inherits2["default"])(ImageAnswerComponent, _React$Component);

    var _super = _createSuper(ImageAnswerComponent);
    ...
    (0, _createClass2["default"])(ImageAnswerComponent, [{
      ...
      value: function renderModal() {
        ...
        var onRemove, onRotate;

        if (!this.state.modalOpen) {
          return null;
        }

        onRemove = this.props.onImageChange ? function () {
          _this3.setState({
            modalOpen: false
          });
        ...
        onRotate = this.props.onImageChange ? function () {
          var image;
