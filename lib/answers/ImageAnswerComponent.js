...
module.exports = ImageAnswerComponent = function () {
  var ImageAnswerComponent = function (_React$Component) {
    _inherits(ImageAnswerComponent, _React$Component);

    function ImageAnswerComponent(props) {
      _classCallCheck(this, ImageAnswerComponent);

      var _this = _possibleConstructorReturn(this, (ImageAnswerComponent.__proto__ || Object.getPrototypeOf(ImageAnswerComponent)).call(this, props));
    ...
    _createClass(ImageAnswerComponent, [{
      key: 'focus',
