var H, ImageAnswerComponent, ImagePopupComponent, ImageThumbnailComponent, PropTypes, React, RotationAwareImageComponent,
...
module.exports = ImageAnswerComponent = (function(superClass) {
  ...
  function ImageAnswerComponent(props) {
    ...
    ImageAnswerComponent.__super__.constructor.call(this, props);
    this.state = {
      modalOpen: false
    };
  }
  ...
  ImageAnswerComponent.prototype.renderModal = function() {
