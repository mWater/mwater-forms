...
module.exports = LikertAnswerComponent = function () {
  ...
  function (_React$Component) {
    ...
    function LikertAnswerComponent() {
      ...
      _this = (0, _possibleConstructorReturn2["default"])(this, (0, _getPrototypeOf2["default"])(LikertAnswerComponent).apply(this, arguments));
    ...
    (0, _createClass2["default"])(LikertAnswerComponent, [{
      ...
      value: function render() {
        ...
        return R('table', {
          className: "",
          style: {
            width: '100%' // IN CASE WE DECIDE TO DISPLAY THE CHOICES AT THE TOP (INSTEAD OF REPEATING THEM)
            //R 'thead', null,
            //  R 'tr', null,
            //    R('td'),
