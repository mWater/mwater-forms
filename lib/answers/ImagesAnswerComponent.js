var H, ImagePopupComponent, ImagesAnswerComponent, PropTypes, React, RotationAwareImageComponent, _,
...
module.exports = ImagesAnswerComponent = (function(superClass) {
  ...
  function ImagesAnswerComponent(props) {
    ...
    ImagesAnswerComponent.__super__.constructor.call(this, props);
    this.state = {
      modalImageId: null
    };
  }
