...
module.exports = SiteAnswerComponent = function () {
  var SiteAnswerComponent = function (_React$Component) {
    _inherits(SiteAnswerComponent, _React$Component);

    function SiteAnswerComponent(props) {
      _classCallCheck(this, SiteAnswerComponent);

      var ref;

      var _this = _possibleConstructorReturn(this, (SiteAnswerComponent.__proto__ || Object.getPrototypeOf(SiteAnswerComponent)).call(this, props));
    ...
    _createClass(SiteAnswerComponent, [{
