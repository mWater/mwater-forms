...
module.exports = EntityAnswerComponent = function () {
  var EntityAnswerComponent = /*#__PURE__*/function (_AsyncLoadComponent) {
    (0, _inherits2["default"])(EntityAnswerComponent, _AsyncLoadComponent);

    var _super = _createSuper(EntityAnswerComponent);

    function EntityAnswerComponent() {
      var _this;

      (0, _classCallCheck2["default"])(this, EntityAnswerComponent);
      _this = _super.apply(this, arguments); // Called to select an entity using an external mechanism (calls @ctx.selectEntity)
