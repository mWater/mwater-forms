...
exports.getHealthRiskString = exports.healthRiskEnum = void 0;
exports.healthRiskEnum = [
    ...
    { id: "possibly_safe", name: { _base: "en", en: "Intermediate Risk/Possibly Safe" }, code: "possibly_safe" },
    { id: "possibly_unsafe", name: { _base: "en", en: "High Risk/Possibly Unsafe" }, code: "possibly_unsafe" },
    { id: "probably_unsafe", name: { _base: "en", en: "High Risk/Probably Unsafe" }, code: "probably_unsafe" },
    { id: "unsafe", name: { _base: "en", en: "Unsafe" }, code: "unsafe" }
];
function getHealthRiskString(healthRiskId, T) {
...
exports.getHealthRiskString = getHealthRiskString;
