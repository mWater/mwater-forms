...
class AquagenxCBTPopupComponent extends react_1.default.Component {
    ...
    static initClass() {
        this.contextTypes = { T: prop_types_1.default.func.isRequired }; // Localizer to use
    }
    componentDidMount() {
        const { main } = this;
...
`);
    ...
    render() {
        return react_1.default.createElement(ModalPopupComponent_1.default, {
            footer: R("div", { id: "footer" }, R("button", { className: "btn btn-primary", id: "save", onClick: this.handleSaveClick }, this.context.T("Save")), R("button", { type: "button", className: "btn btn-default", id: "close", onClick: this.props.onClose }, this.context.T("Cancel"))),
