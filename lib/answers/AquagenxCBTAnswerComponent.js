...
class AquagenxCBTAnswerComponent extends react_1.default.Component {
    ...
    renderImage() {
        var _a;
        return R("div", null, this.state.imageModal, ((_a = this.props.value) === null || _a === void 0 ? void 0 : _a.image) ? react_1.default.createElement(ImageThumbnailComponent_1.default, {
    ...
    renderAquagenxCBT() {
        ...
        return R("div", null, this.state.aquagenxModal, ((_a = this.props.value) === null || _a === void 0 ? void 0 : _a.cbt) == null
            ? R("div", null, R("button", { className: "btn btn-default", onClick: this.handleEditClick }, this.context.T("Record")))
            : R("div", null, R(AquagenxCBTDisplayComponent_1.default, {
                value: this.props.value,
                questionId: this.props.questionId,
                onEdit: this.handleEditClick
            }), R("div", null, R("button", { className: "btn btn-default", onClick: this.handleEditClick }, R("span", { className: "glyphicon glyphicon-edit" }), " ", this.context.T("Edit")), R("button", { className: "btn btn-default", onClick: this.handleClearClick, style: { marginLeft: "12px" } }, R("span", { className: "glyphicon glyphicon-remove" }), " ", this.context.T("Clear")))));
    }
    render() {
