var AquagenxCBTAnswerComponent, AquagenxCBTDisplayComponent, AquagenxCBTPopupComponent, H, ImagePopupComponent, ImageThumbnailComponent, R, React, formUtils,
...
module.exports = AquagenxCBTAnswerComponent = (function(superClass) {
  ...
  function AquagenxCBTAnswerComponent(props) {
    ...
    AquagenxCBTAnswerComponent.__super__.constructor.apply(this, arguments);
    this.state = {
      imageModal: null,
      aquagenxModal: null
    };
  ...
  AquagenxCBTAnswerComponent.prototype.renderImage = function() {
    return H.div(null, this.state.imageModal, this.props.value.image ? React.createElement(ImageThumbnailComponent, {
  ...
  AquagenxCBTAnswerComponent.prototype.renderAquagenxCBT = function() {
    return H.div(null, this.state.aquagenxModal, this.props.value.cbt == null ? H.div(null, H.button({
