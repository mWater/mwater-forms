...
module.exports = AquagenxCBTAnswerComponent = function () {
  var AquagenxCBTAnswerComponent = function (_React$Component) {
    _inherits(AquagenxCBTAnswerComponent, _React$Component);

    function AquagenxCBTAnswerComponent(props) {
      _classCallCheck(this, AquagenxCBTAnswerComponent);

      var _this = _possibleConstructorReturn(this, (AquagenxCBTAnswerComponent.__proto__ || Object.getPrototypeOf(AquagenxCBTAnswerComponent)).call(this, props));
    ...
    _createClass(AquagenxCBTAnswerComponent, [{
      key: 'focus',
