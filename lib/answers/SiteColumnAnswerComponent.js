...
class SiteColumnAnswerComponent extends react_1.default.Component {
    ...
    render() {
        ...
        if ((_a = this.props.value) === null || _a === void 0 ? void 0 : _a.code) {
            return R("div", null, R("button", { className: "btn btn-link btn-sm float-right", onClick: this.handleClearClick }, R("span", { className: "fas fa-times" })), R(EntityDisplayComponent_1.default, {
                entityType: this.props.siteType,
