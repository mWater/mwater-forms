  ...
  definitions: {
    ...
    rosterMatrix: {
      ...
      properties: {
        ...
        contents: {
          type: "array",
          items: {
            $ref: "#/definitions/rosterMatrixColumn"
          }
        }
      },
      required: ["_id", "_type", "name", "conditions", "contents"]
    ...
    rosterMatrixColumn: {
      ...
      properties: {
        ...
        _type: {
          "enum": ["TextColumnQuestion", "NumberColumnQuestion", "CheckColumnQuestion", "DropdownColumnQuestion", "UnitsColumnQuestion", "TextColumn"]
        },
        text: {
          $ref: "#/definitions/localizedString"
        },
