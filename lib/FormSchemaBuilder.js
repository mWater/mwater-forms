...
module.exports = FormSchemaBuilder = (function() {
  ...
  FormSchemaBuilder.prototype.addForm = function(schema, form, cloneForms) {
    ...
    if (form.design.calculations && form.design.calculations.length > 0) {
      this.addCalculations(form.design.calculations, contents, "responses:" + form._id);
    }
  ...
  FormSchemaBuilder.prototype.addFormItem = function(item, contents, tableId, conditionsExprCompiler, existingConditionExpr, reverseJoins) {
    var addColumn, addCxColumn, answerType, cellCode, choice, code, codeExpr, column, conditionExpr, entityType, formId, i, itemCode, itemColumn, itemItem, j, jsonql, k, l, len, len1, len2, len3, len4, len5, m, n, name, ref, ref1, ref2, ref3, ref4, ref5, ref6, ref7, ref8, results, reverseJoin, section, sectionConditionExpr, sectionContents, sections, subitem, webmercatorLocation;
  ...
  FormSchemaBuilder.prototype.addCalculations = function(calculations, contents, tableId) {
    var calculation, i, len, section;
    section = {
      type: "section",
      name: {
        _base: "en",
    ...
    for (i = 0, len = calculations.length; i < len; i++) {
