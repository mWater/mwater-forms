...
module.exports = FormSchemaBuilder = (function() {
  ...
  FormSchemaBuilder.prototype.addIndicatorCalculations = function(schema, form, indicators, isMaster) {
    ...
    for (i = 0, len = ref.length; i < len; i++) {
      ...
      indicatorCalculationSection = this.createIndicatorCalculationSection(indicatorCalculation, schema, indicators, isMaster);
  ...
  FormSchemaBuilder.prototype.createIndicatorCalculationSection = function(indicatorCalculation, schema, indicators, isMaster) {
