...
module.exports = FormSchemaBuilder = function () {
  ...
  (0, _createClass3.default)(FormSchemaBuilder, [{
    ...
    value: function addForm(schema, form, cloneForms) {
      ...
      schema = this.addRosterTables(schema, form, conditionsExprCompiler, reverseJoins, 'responses:' + form._id);
    ...
    key: 'addRosterTables',
    value: function addRosterTables(schema, form, conditionsExprCompiler, reverseJoins, tableId) {
