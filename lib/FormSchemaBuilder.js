...
function () {
  ...
  (0, _createClass2["default"])(FormSchemaBuilder, [{
    ...
    value: function addFormItem(item, contents, tableId, conditionsExprCompiler, existingConditionExpr) {
      ...
      var addColumn, addCxColumn, answerType, cellCode, choice, code, codeExpr, column, conditionExpr, dataColumn, entityType, formId, i, itemCode, itemColumn, itemItem, j, jsonql, k, l, len, len1, len2, len3, len4, len5, len6, m, n, name, o, ref, ref1, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, results, reverseJoin, rosterId, section, sectionConditionExpr, sectionContents, sections, subitem, webmercatorLocation;
          ...
          case "matrix":
            ...
            for (m = 0, len4 = ref7.length; m < len4; m++) {
              ...
              for (n = 0, len5 = ref8.length; n < len5; n++) {
                itemColumn = ref8[n];
                cellCode = code && itemItem.code && itemColumn.code ? code + " - " + itemItem.code + " - " + itemColumn.code : void 0; // TextColumnQuestion
