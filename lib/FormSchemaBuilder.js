 ...
 */
var ColumnNotFoundException, ExprCompiler, ExprUtils, FormSchemaBuilder, TopoSort, _, appendStr, formUtils, healthRiskEnum, mapTree, update;
...
module.exports = FormSchemaBuilder = (function() {
  ...
  FormSchemaBuilder.prototype.addFormItem = function(item, contents, tableId) {
    var addColumn, addCxColumn, answerType, cellCode, choice, code, codeExpr, column, i, itemCode, itemColumn, itemItem, j, k, l, len, len1, len2, len3, len4, len5, m, n, name, ref, ref1, ref2, ref3, ref4, ref5, ref6, ref7, results, section, sectionContents, sections, subitem, webmercatorLocation;
