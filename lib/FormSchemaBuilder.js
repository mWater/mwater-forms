...
module.exports = FormSchemaBuilder = (function() {
  ...
  FormSchemaBuilder.prototype.addForm = function(schema, form, cloneForms) {
    var conditionsExprCompiler, contents, deploymentValues, reverseJoins;
    contents = [];
      ...
      if (schema.getTable(reverseJoin.table)) {
        ...
        if (sectionIndex < 0) {
          section = {
            ...
            desc: {
              en: "Forms (surveys) that are linked by a question to " + table.name.en
            },
            contents: []
          };
          table = update(table, {
                  ...
                  exprs: [
                    {
                      ...
                      exprs: [
                        "question", item._id, "entityType", entityType, "property", "code", "value", {
                          type: "field",
                          tableAlias: "{from}",
                          column: "code"
                        }
                    ...
                    exprs: [
                      {
                        ...
                        op: "jsonb_build_object",
                        exprs: [
                          "question", item._id, "entityType", item.entityType, "property", "_id", "value", {
                            type: "field",
                            tableAlias: "{from}",
                            column: "_id"
                          }
