...
module.exports = FormSchemaBuilder = (function() {
  ...
  FormSchemaBuilder.prototype.addFormItem = function(form, item, contents) {
    var addColumn, answerType, cellCode, choice, code, codeExpr, column, i, itemCode, itemColumn, itemItem, j, k, l, len, len1, len2, len3, len4, len5, m, n, name, ref, ref1, ref2, ref3, ref4, ref5, ref6, ref7, results, section, sectionContents, sections, subitem;
        ...
        for (n = 0, len5 = ref7.length; n < len5; n++) {
          ...
          if (choice.specify) {
            column = {
              ...
              code: code ? code + (" (" + (choice.code ? choice.code : formUtils.localizeString(choice.name)) + ")") : void 0,
              jsonql: {
                type: "op",
                op: "#>>",
                exprs: [
