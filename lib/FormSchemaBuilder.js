...
module.exports = FormSchemaBuilder = function () {
  function FormSchemaBuilder() {
    (0, _classCallCheck3.default)(this, FormSchemaBuilder);
  }

  (0, _createClass3.default)(FormSchemaBuilder, [{
    key: 'addForm',
    ...
    value: function addForm(schema, form, cloneForms) {
      var isAdmin = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : true;
      var indicators = arguments[4];
    ...
    key: 'addRosterTables',
    value: function addRosterTables(schema, form, conditionsExprCompiler, reverseJoins) {
    ...
    key: 'addMasterForm',
    value: function addMasterForm(schema, form, cloneForms, indicators) {
    ...
    value: function addIndicatorCalculations(schema, form, indicators, isMaster) {
    ...
    value: function createIndicatorCalculationSection(indicatorCalculation, schema, indicators, isMaster, form) {
      ...
      for (i = 0, len = ref.length; i < len; i++) {
        ...
        for (j = 0, len1 = properties.length; j < len1; j++) {
          ...
          if (isMaster && expression) {
            expression = JSON.parse((0, _stringify2.default)(expression).replace(/table":"responses:/g, "table\":\"master_responses:"));
          }
          // If master, hack condition to be from master_responses, not responses
          if (isMaster && condition) {
            condition = JSON.parse((0, _stringify2.default)(condition).replace(/table":"responses:/g, "table\":\"master_responses:"));
          }
