...
export declare type RosterData = RosterEntry[];
...
/** Choice id */
export declare type ChoiceAnswerValue = string;
/** Choice ids */
export declare type ChoicesAnswerValue = string[];
export declare type BooleanAnswerValue = boolean;
/** YYYY-MM-DD */
...
export declare type ImagesAnswerValue = ImageAnswerValue[];
export declare type TextsAnswerValue = string[];
export interface SiteAnswerValue {
    /** Code of site e.g. "10007" */
    code: string;
}
/** Entity id is the string value */
export declare type EntityAnswerValue = string;
...
export declare type AdminRegionAnswerValue = number;
...
/** _id of the row */
export declare type CascadingRefAnswerValue = string;
