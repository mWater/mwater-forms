var AdminRegionSelectComponent, AsyncLoadComponent, H, PropTypes, R, React, _,
...
module.exports = AdminRegionSelectComponent = (function(superClass) {
  ...
  AdminRegionSelectComponent.prototype.componentWillMount = function(props) {
    AdminRegionSelectComponent.__super__.componentWillMount.call(this, props);
  ...
  AdminRegionSelectComponent.prototype.renderLevel = function(level) {
    ...
    return H.tr({
      ...
      key: "none",
      value: ""
    }, this.state.path[level] ? this.props.T("None") : this.props.T("Select...")), this.state["level" + level + "s"] ? _.map(this.state["level" + level + "s"], (function(_this) {
