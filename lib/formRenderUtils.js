...
RosterMatrixComponent = require('./RosterMatrixComponent'); // Render an item, given its data, visibility function, etc.

exports.renderItem = function (item, data, responseRow, schema, onDataChange, isVisible, onNext, ref) {
  ...
  if (formUtils.isQuestion(item)) {
    ...
    throw new Error("Unknown item of type ".concat(item._type));
  }
};