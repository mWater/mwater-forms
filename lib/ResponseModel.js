...
module.exports = ResponseModel = function () {
  function ResponseModel(options) {
    (0, _classCallCheck3.default)(this, ResponseModel);
  ...
  (0, _createClass3.default)(ResponseModel, [{
    key: 'draft',
    ...
    value: function canRedraft() {
      ...
      if ((ref = this.response.status) === 'pending' || ref === 'rejected' || ref === 'draft') {
        return ref1 = 'user:' + this.response.user, indexOf.call(subjects, ref1) >= 0; // Final
      } else {
