...
module.exports = ResponseModel = (function() {
  ...
  ResponseModel.prototype._generateEntityCreates = function() {
    var compiler, create, creates, deployment, entity, extraCreateRole, j, k, l, len, len1, len2, model, question, ref, ref1, ref2, role, roles, settings;
    creates = [];
        ...
        tasks.push((function(_this) {
          return function(cb) {
            return db[update.entityType].findOne({
              ...
              return db[update.entityType].upsert(updated, entity, function(successEntity) {
