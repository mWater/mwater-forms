...
class ResponseModel {
    ...
    canSubmit() {
        ...
        let admins = lodash_1.default.union(lodash_1.default.pluck(lodash_1.default.where(this.form.roles, { role: "admin" }), "id"), deployment.admins, deployment.superadmins || []);
        // Add enumerator
    ...
    canApprove() {
        ...
        const admins = lodash_1.default.union(lodash_1.default.pluck(lodash_1.default.where(this.form.roles, { role: "admin" }), "id"), deployment.admins, deployment.superadmins || [], ((_a = deployment.approvalStages[this.response.approvals.length]) === null || _a === void 0 ? void 0 : _a.approvers) || []);
        let subjects = ["user:" + this.user, "all"];
        subjects = subjects.concat(lodash_1.default.map(this.groups, (g) => "group:" + g));
    ...
    canReject() {
        ...
        if (this.response.status === "pending") {
            // Get list of admins at both deployment and form level and add approvers
            admins = lodash_1.default.union(lodash_1.default.pluck(lodash_1.default.where(this.form.roles, { role: "admin" }), "id"), deployment.admins, deployment.superadmins || [], ((_a = deployment.approvalStages[this.response.approvals.length]) === null || _a === void 0 ? void 0 : _a.approvers) || []);
            ...
            admins = lodash_1.default.union(lodash_1.default.pluck(lodash_1.default.where(this.form.roles, { role: "admin" }), "id"), deployment.admins, deployment.superadmins || []);
            subjects = ["user:" + this.user, "all"];
            subjects = subjects.concat(lodash_1.default.map(this.groups, (g) => "group:" + g));
            return lodash_1.default.intersection(admins, subjects).length > 0;
        }
