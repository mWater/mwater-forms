...
var CustomRow = /** @class */ (function () {
    ...
    CustomRow.prototype.getField = function (columnId) {
        return __awaiter(this, void 0, void 0, function () {
            var column, value, entityType_1, entity;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!(column.type == "join")) return [3 /*break*/, 4];
                        if (!column.join.toTable.match(/^entities./)) return [3 /*break*/, 2];
                        entityType_1 = column.join.toTable.substr(9);
