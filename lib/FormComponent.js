...
class FormComponent extends react_1.default.Component {
    constructor(props) {
        ...
        this.handleDataChange = (data) => {
            ...
            const defaultValueApplier = this.props.formCtx.stickyStorage ? new DefaultValueApplier_1.default(this.props.design, this.props.formCtx.stickyStorage, this.props.entity, this.props.entityType) : null;
