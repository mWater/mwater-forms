var CleaningEntity, FormComponent, H, ItemListComponent, R, React, SectionsComponent, StickyEntity, VisibilityEntity, _,
...
module.exports = FormComponent = (function(superClass) {
  ...
  FormComponent.prototype.stickyData = function(data, previousVisibilityStructure, newVisibilityStructure) {
    ...
    return stickyEntity.setStickyData(this.props.design, data, this.context.stickyStorage, previousVisibilityStructure, newVisibilityStructure);
  };
