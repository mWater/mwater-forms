var DefaultValueApplier, FormComponent, H, ItemListComponent, R, React, ResponseCleaner, ResponseRow, SectionsComponent, VisibilityCalculator, _, ezlocalize,
...
module.exports = FormComponent = (function(superClass) {
  ...
  FormComponent.prototype.handleDataChange = function(data) {
    var defaultValueApplier, responseCleaner, visibilityCalculator;
    ...
    return responseCleaner.cleanData(this.props.design, visibilityCalculator, defaultValueApplier, data, this.createResponseRow, this.state.visibilityStructure, (function(_this) {
  ...
  FormComponent.prototype.render = function() {
    if (this.props.design.contents[0] && this.props.design.contents[0]._type === "Section" && !this.props.singlePageMode) {
      ...
      }, this.state.T("Submit")) : void 0, "\u00A0", this.props.onSaveLater ? [
        H.button({
          type: "button",
          key: 'saveLaterButton',
