var DefaultValueApplier, FormComponent, FormExprEvaluator, H, ItemListComponent, R, React, ResponseCleaner, ResponseRow, SectionsComponent, VisibilityCalculator, _, ezlocalize,
...
module.exports = FormComponent = (function(superClass) {
  ...
  FormComponent.prototype.handleDataChange = function(data) {
    var defaultValueApplier, responseCleaner, responseRowFactory, visibilityCalculator;
    ...
    responseRowFactory = (function(_this) {
      return function(data) {
        return new ResponseRow({
          responseData: data,
          formDesign: _this.props.design,
          getEntityById: _this.props.formCtx.getEntityById,
          getEntityByCode: _this.props.formCtx.getEntityByCode
        });
      };
    })(this);
    return responseCleaner.cleanData(this.props.design, visibilityCalculator, defaultValueApplier, data, responseRow, this.state.visibilityStructure, (function(_this) {
