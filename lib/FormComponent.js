...
class FormComponent extends react_1.default.Component {
    constructor(props) {
        ...
        this.handleDataChange = (data) => {
            ...
            const defaultValueApplier = new DefaultValueApplier_1.default(this.props.design, this.props.formCtx.stickyStorage, this.props.entity, this.props.entityType);
    ...
    render() {
        if (this.props.design.contents[0] &&
            ...
            return R("div", null, R(ItemListComponent_1.default, {
                ...
                ? R("button", { type: "button", key: "discardButton", className: "btn btn-default", onClick: this.props.onDiscard }, this.props.discardLabel
