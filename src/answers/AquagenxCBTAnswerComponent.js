...
export default AquagenxCBTAnswerComponent = (function() {
  AquagenxCBTAnswerComponent = class AquagenxCBTAnswerComponent extends React.Component {
    static initClass() {
      this.contextTypes = {
    ...
    renderImage() {
      return R('div', null,
        ...
        this.props.value?.image ?
          React.createElement(ImageThumbnailComponent, {imageId: this.props.value.image.id, onClick: this.handleClickImage, imageManager: this.context.imageManager})
    ...
    renderAquagenxCBT() {
      return R('div', null,
        ...
        (this.props.value?.cbt == null) ?
          R('div', null,
            R('button', {className: 'btn btn-default', onClick: this.handleEditClick},
              this.context.T('Record'))
          )
        :
          R('div', null,
            ...
            R('div', null,
              R('button', {className: 'btn btn-default', onClick: this.handleEditClick},
                ...
                " ",
                this.context.T('Edit')),
              R('button', {className: 'btn btn-default', onClick: this.handleClearClick, style: {marginLeft: '12px'}},
