...
export default AdminRegionAnswerComponent = (function() {
  AdminRegionAnswerComponent = class AdminRegionAnswerComponent extends React.Component {
    ...
    renderEntityButtons() {
      return R('div', null,
        !this.state.waiting ?
          R('button', {type: "button", className: "btn btn-link btn-sm", onClick: this.handleUseGPS, disabled: (this.context.locationFinder == null)},
            R('span', {className: "glyphicon glyphicon-screenshot"}),
            " ",
            this.context.T("Set Using GPS"))
        :
          R('button', {type: "button", className: "btn btn-link btn-sm", onClick: this.handleCancelUseGPS, disabled: (this.context.locationFinder == null)},
            R('span', {className: "glyphicon glyphicon-remove"}),
            " ",
            this.context.T("Cancel GPS")),

        R('button', {type: "button", className: "btn btn-link btn-sm", onClick: this.handleUseMap, disabled: (this.context.displayMap == null)},
    ...
    render() {
      return R('div', null,
        ...
        this.state.waiting ?
          R('div', {className: "text-info"}, this.context.T("Waiting for GPS...")) : undefined,

        this.state.error ?
          R('div', {className: "text-danger"}, this.state.error) : undefined,
