...
export default DateTimePickerComponent = (function() {
  DateTimePickerComponent = class DateTimePickerComponent extends React.Component {
    ...
    render() {
      ...
      const input = R('input', { type: "text", className: "form-control", placeholder: this.props.placeholder, onFocus: this.handleInputFocus, style: { zIndex: "inherit", minWidth: "12em" } });

      return R('div', {className: 'input-group date', ref: (c => { return this.datetimepicker = c; })},
        input,
        R('span', {className: "input-group-addon", onClick: this.handleCalendarClick},
