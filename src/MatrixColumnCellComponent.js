    ...
    render() {
      ...
      switch (column._type) {
        ...
        case "TextColumnQuestion":
          elem = R('input', {type: "text", className: "form-control input-sm", value: value || "", onChange: ev => this.handleValueChange(ev.target.value)});
          break;
        case "NumberColumnQuestion":
          elem = R(NumberAnswerComponent, {small: true, style: { maxWidth: "10em"}, decimal: column.decimal, value, onChange: this.handleValueChange});
          break;
        ...
        case "DateColumnQuestion":
          elem = R('div', {style: {maxWidth: "18em"}},
            R(DateAnswerComponent, {format: column.format, placeholder: column.placeholder, value, onValueChange: this.handleValueChange}));
          break;
      }
