        ...
        R('div', null,
          ...
          R('div', null,
            this.props.onSetCover ?
              R('button', {type: "button", className: "btn btn-link", onClick: this.props.onSetCover}, this.props.T("Set as Cover Image")) : undefined,
            " ",
            this.props.onRemove ?
              R('button', {type: "button", className: "btn btn-link", onClick: this.props.onRemove}, this.props.T("Remove")) : undefined,
            " ",
            this.props.onRotate ?
              R('button', {type: "button", className: "btn btn-link", onClick: this.props.onRotate}, this.props.T("Rotate")) : undefined
          ),
